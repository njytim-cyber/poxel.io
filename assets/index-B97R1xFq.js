...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ja(e,t,n){let r=new Float32Array(Pa),i=new V(0,1,0);return new hi({name:`SphericalGaussianBlur`,defines:{n:Pa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Za(),fragmentShader:`
	...
	`}var Qa=class extends jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new ti([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
}`,Dc=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new ai(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new hi({vertexShader:Tc,fragmentShader:Ec,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new G(new si(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Oc=class extends rt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new Dc,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new B,O=null,k=new qi;k.viewport=new kt;let te=new qi;te.viewport=new kt;let ne=[k,te],A=new ta,re=null,j=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new dn,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new dn,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new dn,C[e]=t),t.getHandSpace()};function ie(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ae(){r.removeEventListener(`select`,ie),r.removeEventListener(`selectstart`,ie),r.removeEventListener(`selectend`,ie),r.removeEventListener(`squeeze`,ie),r.removeEventListener(`squeezestart`,ie),r.removeEventListener(`squeezeend`,ie),r.removeEventListener(`end`,ae),r.removeEventListener(`inputsourceschange`,oe);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}re=null,j=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,pe.stop(),n.isPresenting=!1,e.setPixelRatio(O),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,ie),r.addEventListener(`selectstart`,ie),r.addEventListener(`selectend`,ie),r.addEventListener(`squeeze`,ie),r.addEventListener(`squeezestart`,ie),r.addEventListener(`squeezeend`,ie),r.addEventListener(`end`,ae),r.addEventListener(`inputsourceschange`,oe),b.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new jt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new ri(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new jt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),pe.setContext(r),pe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function oe(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let M=new V,se=new V;function ce(e,t,n){M.setFromMatrixPosition(t.matrixWorld),se.setFromMatrixPosition(n.matrixWorld);let r=M.distanceTo(se),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function le(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),A.near=te.near=k.near=t,A.far=te.far=k.far=n,(re!==A.near||j!==A.far)&&(r.updateRenderState({depthNear:A.near,depthFar:A.far}),re=A.near,j=A.far),A.layers.mask=e.layers.mask|6,k.layers.mask=A.layers.mask&-5,te.layers.mask=A.layers.mask&-3;let i=e.parent,a=A.cameras;le(A,i);for(let e=0;e<a.length;e++)le(a[e],i);a.length===2?ce(A,k,te):A.projectionMatrix.copy(k.projectionMatrix),ue(e,A,i)};function ue(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=ot*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(A)},this.getCameraTexture=function(e){return v[e]};let de=null;function fe(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==A.cameras.length&&(A.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=ne[n];o===void 0&&(o=new qi,o.layers.enable(n),o.viewport=new kt,ne[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(A.matrix.copy(o.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),i===!0&&A.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new ai,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}de&&de(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let pe=new xa;pe.setAnimationLoop(fe),this.setAnimationLoop=function(e){de=e},this.dispose=function(){}}},kc=new Wt,Ac=new Pt;function jc(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,di(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,kc.copy(o),kc.x*=-1,kc.y*=-1,kc.z*=-1,a.isCubeTexture&&a.isRenderTargetTexture===!1&&(kc.y*=-1,kc.z*=-1),e.envMapRotation.value.setFromMatrix4(Ac.makeRotationFromEuler(kc)),e.flipEnvMap.value=a.isCubeTexture&&a.isRenderTargetTexture===!1?-1:1,e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Mc(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(m(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,g));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return R(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let t=0,n=r.length;t<n;t++){let n=Array.isArray(r[t])?r[t]:[r[t]];for(let r=0,i=n.length;r<i;r++){let i=n[r];if(p(i,t,r,a)===!0){let t=i.__offset,n=Array.isArray(i.value)?i.value:[i.value],r=0;for(let a=0;a<n.length;a++){let o=n[a],s=h(o);typeof o==`number`||typeof o==`boolean`?(i.__data[0]=o,e.bufferSubData(e.UNIFORM_BUFFER,t+r,i.__data)):o.isMatrix3?(i.__data[0]=o.elements[0],i.__data[1]=o.elements[1],i.__data[2]=o.elements[2],i.__data[3]=0,i.__data[4]=o.elements[3],i.__data[5]=o.elements[4],i.__data[6]=o.elements[5],i.__data[7]=0,i.__data[8]=o.elements[6],i.__data[9]=o.elements[7],i.__data[10]=o.elements[8],i.__data[11]=0):(o.toArray(i.__data,r),r+=s.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,t,i.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function m(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=h(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function h(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?L(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):L(`WebGLRenderer: Unsupported uniform value type.`,e),t}function g(t){let n=t.target;n.removeEventListener(`dispose`,g);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function _(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:_}}var Nc=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Pc=null;function Fc(){return Pc===null&&(Pc=new Lr(Nc,16,16,O,g),Pc.name=`DFG_LUT`,Pc.minFilter=o,Pc.magFilter=o,Pc.wrapS=t,Pc.wrapT=t,Pc.generateMipmaps=!1,Pc.needsUpdate=!0),Pc}var Ic=class{constructor(e={}){let{canvas:t=Ye(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([te,k,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=null,O=null,ne=[],A=[],re=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let j=this,ie=!1;this._outputColorSpace=ze;let ae=0,oe=0,M=null,se=-1,ce=null,le=new kt,ue=new kt,de=null,fe=new W(0),pe=0,me=t.width,he=t.height,ge=1,_e=null,ve=null,ye=new kt(0,0,me,he),be=new kt(0,0,me,he),xe=!1,Se=new ei,Ce=!1,we=!1,Te=new Pt,Ee=new V,De=new kt,Oe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},ke=!1;function Ae(){return M===null?ge:1}let N=n;function je(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r183`),t.addEventListener(`webglcontextlost`,st,!1),t.addEventListener(`webglcontextrestored`,z,!1),t.addEventListener(`webglcontextcreationerror`,ct,!1),N===null){let t=`webgl2`;if(N=je(t,e),N===null)throw je(t)?Error(`Error creating WebGL context with your selected attributes.`):Error(`Error creating WebGL context.`)}}catch(e){throw R(`WebGLRenderer: `+e.message),e}let Me,Ne,P,Pe,F,I,Fe,Ie,Le,Re,Ve,He,Ue,We,Ke,qe,Je,Xe,Ze,$e,nt,rt,it;function at(){Me=new eo(N),Me.init(),nt=new wc(N,Me),Ne=new Aa(N,Me,e,nt),P=new Sc(N,Me),Ne.reversedDepthBuffer&&h&&P.buffers.depth.setReversed(!0),Pe=new ro(N),F=new nc,I=new Cc(N,Me,P,F,Ne,nt,Pe),Fe=new $a(j),Ie=new Sa(N),rt=new Oa(N,Ie),Le=new to(N,Ie,Pe,rt),Re=new ao(N,Le,Ie,rt,Pe),Xe=new io(N,Ne,I),Ke=new ja(F),Ve=new tc(j,Fe,Me,Ne,rt,Ke),He=new jc(j,F),Ue=new oc,We=new pc(Me),Je=new Da(j,Fe,P,Re,x,s),qe=new xc(j,Re,Ne),it=new Mc(N,Pe,Ne,P),Ze=new ka(N,Me,Pe),$e=new no(N,Me,Pe),Pe.programs=Ve.programs,j.capabilities=Ne,j.extensions=Me,j.properties=F,j.renderLists=Ue,j.shadowMap=qe,j.state=P,j.info=Pe}at(),S!==1009&&(re=new so(S,t.width,t.height,r,i));let ot=new Oc(j,N);this.xr=ot,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){let e=Me.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Me.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return ge},this.setPixelRatio=function(e){e!==void 0&&(ge=e,this.setSize(me,he,!1))},this.getSize=function(e){return e.set(me,he)},this.setSize=function(e,n,r=!0){if(ot.isPresenting){L(`WebGLRenderer: Can't change size while VR device is presenting.`);return}me=e,he=n,t.width=Math.floor(e*ge),t.height=Math.floor(n*ge),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),re!==null&&re.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(me*ge,he*ge).floor()},this.setDrawingBufferSize=function(e,n,r){me=e,he=n,ge=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){console.error(`THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){console.warn(`THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}re.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(le)},this.getViewport=function(e){return e.copy(ye)},this.setViewport=function(e,t,n,r){e.isVector4?ye.set(e.x,e.y,e.z,e.w):ye.set(e,t,n,r),P.viewport(le.copy(ye).multiplyScalar(ge).round())},this.getScissor=function(e){return e.copy(be)},this.setScissor=function(e,t,n,r){e.isVector4?be.set(e.x,e.y,e.z,e.w):be.set(e,t,n,r),P.scissor(ue.copy(be).multiplyScalar(ge).round())},this.getScissorTest=function(){return xe},this.setScissorTest=function(e){P.setScissorTest(xe=e)},this.setOpaqueSort=function(e){_e=e},this.setTransparentSort=function(e){ve=e},this.getClearColor=function(e){return e.copy(Je.getClearColor())},this.setClearColor=function(){Je.setClearColor(...arguments)},this.getClearAlpha=function(){return Je.getClearAlpha()},this.setClearAlpha=function(){Je.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(M!==null){let t=M.texture.format;e=C.has(t)}if(e){let e=M.texture.type,t=w.has(e),n=Je.getClearColor(),r=Je.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,N.clearBufferuiv(N.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,N.clearBufferiv(N.COLOR,0,E))}else r|=N.COLOR_BUFFER_BIT}t&&(r|=N.DEPTH_BUFFER_BIT),n&&(r|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&N.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener(`webglcontextlost`,st,!1),t.removeEventListener(`webglcontextrestored`,z,!1),t.removeEventListener(`webglcontextcreationerror`,ct,!1),Je.dispose(),Ue.dispose(),We.dispose(),F.dispose(),Fe.dispose(),Re.dispose(),rt.dispose(),it.dispose(),Ve.dispose(),ot.dispose(),ot.removeEventListener(`sessionstart`,mt),ot.removeEventListener(`sessionend`,H),ht.stop()};function st(e){e.preventDefault(),Qe(`WebGLRenderer: Context Lost.`),ie=!0}function z(){Qe(`WebGLRenderer: Context Restored.`),ie=!1;let e=Pe.autoReset,t=qe.enabled,n=qe.autoUpdate,r=qe.needsUpdate,i=qe.type;at(),Pe.autoReset=e,qe.enabled=t,qe.autoUpdate=n,qe.needsUpdate=r,qe.type=i}function ct(e){R(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function lt(e){let t=e.target;t.removeEventListener(`dispose`,lt),ut(t)}function ut(e){dt(e),F.remove(e)}function dt(e){let t=F.get(e).programs;t!==void 0&&(t.forEach(function(e){Ve.releaseProgram(e)}),e.isShaderMaterial&&Ve.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Oe);let o=i.isMesh&&i.matrixWorld.determinant()<0,s=wt(e,t,n,r,i);P.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Le.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;rt.setup(i,r,s,n,c);let h,g=Ze;if(c!==null&&(h=Ie.get(c),g=$e,g.setIndex(h)),i.isMesh)r.wireframe===!0?(P.setLineWidth(r.wireframeLinewidth*Ae()),g.setMode(N.LINES)):g.setMode(N.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),P.setLineWidth(e*Ae()),i.isLineSegments?g.setMode(N.LINES):i.isLineLoop?g.setMode(N.LINE_LOOP):g.setMode(N.LINE_STRIP)}else i.isPoints?g.setMode(N.POINTS):i.isSprite&&g.setMode(N.TRIANGLES);if(i.isBatchedMesh)if(i._multiDrawInstances!==null)et(`WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection.`),g.renderMultiDrawInstances(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount,i._multiDrawInstances);else if(Me.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Ie.get(c).bytesPerElement:1,o=F.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(N,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function B(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,xt(e,t,n),e.side=0,e.needsUpdate=!0,xt(e,t,n),e.side=2):xt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),O=We.get(n),O.init(t),A.push(O),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(O.pushLight(e),e.castShadow&&O.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(O.pushLight(e),e.castShadow&&O.pushShadow(e))}),O.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];B(a,n,e),r.add(a)}else B(t,n,e),r.add(t)}),O=A.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){F.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Me.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let ft=null;function pt(e){ft&&ft(e)}function mt(){ht.stop()}function H(){ht.start()}let ht=new xa;ht.setAnimationLoop(pt),typeof self<`u`&&ht.setContext(self),this.setAnimationLoop=function(e){ft=e,ot.setAnimationLoop(e),e===null?ht.stop():ht.start()},ot.addEventListener(`sessionstart`,mt),ot.addEventListener(`sessionend`,H),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){R(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ie===!0)return;let n=ot.enabled===!0&&ot.isPresenting===!0,r=re!==null&&(M===null||n)&&re.begin(j,M);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),ot.enabled===!0&&ot.isPresenting===!0&&(re===null||re.isCompositing()===!1)&&(ot.cameraAutoUpdate===!0&&ot.updateCamera(t),t=ot.getCamera()),e.isScene===!0&&e.onBeforeRender(j,e,t,M),O=We.get(e,A.length),O.init(t),A.push(O),Te.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Se.setFromProjectionMatrix(Te,Ge,t.reversedDepth),we=this.localClippingEnabled,Ce=Ke.init(this.clippingPlanes,we),D=Ue.get(e,ne.length),D.init(),ne.push(D),ot.enabled===!0&&ot.isPresenting===!0){let e=j.xr.getDepthSensingMesh();e!==null&&gt(e,t,-1/0,j.sortObjects)}gt(e,t,0,j.sortObjects),D.finish(),j.sortObjects===!0&&D.sort(_e,ve),ke=ot.enabled===!1||ot.isPresenting===!1||ot.hasDepthSensing()===!1,ke&&Je.addToRenderList(D,e),this.info.render.frame++,Ce===!0&&Ke.beginShadows();let i=O.state.shadowsArray;if(qe.render(i,e,t),Ce===!0&&Ke.endShadows(),this.info.autoReset===!0&&this.info.reset(),(r&&re.hasRenderPass())===!1){let n=D.opaque,r=D.transmissive;if(O.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];vt(n,r,e,a)}ke&&Je.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];_t(D,e,n,n.viewport)}}else r.length>0&&vt(n,r,e,t),ke&&Je.render(e),_t(D,e,t)}M!==null&&oe===0&&(I.updateMultisampleRenderTarget(M),I.updateRenderTargetMipmap(M)),r&&re.end(j),e.isScene===!0&&e.onAfterRender(j,e,t),rt.resetDefaultState(),se=-1,ce=null,A.pop(),A.length>0?(O=A[A.length-1],Ce===!0&&Ke.setGlobalState(j.clippingPlanes,O.state.camera)):O=null,ne.pop(),D=ne.length>0?ne[ne.length-1]:null};function gt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLight)O.pushLight(e),e.castShadow&&O.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||Se.intersectsSprite(e)){r&&De.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Te);let t=Re.update(e),i=e.material;i.visible&&D.push(e,t,i,n,De.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||Se.intersectsObject(e))){let t=Re.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),De.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),De.copy(e.boundingSphere.center)),De.applyMatrix4(e.matrixWorld).applyMatrix4(Te)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&D.push(e,t,s,n,De.z,o)}}else i.visible&&D.push(e,t,i,n,De.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)gt(i[e],t,n,r)}function _t(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;O.setupLightsView(n),Ce===!0&&Ke.setGlobalState(j.clippingPlanes,n),r&&P.viewport(le.copy(r)),i.length>0&&yt(i,t,n),a.length>0&&yt(a,t,n),o.length>0&&yt(o,t,n),P.buffers.depth.setTest(!0),P.buffers.depth.setMask(!0),P.buffers.color.setMask(!0),P.setPolygonOffset(!1)}function vt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(O.state.transmissionRenderTarget[r.id]===void 0){let e=Me.has(`EXT_color_buffer_half_float`)||Me.has(`EXT_color_buffer_float`);O.state.transmissionRenderTarget[r.id]=new jt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Ne.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:U.workingColorSpace})}let a=O.state.transmissionRenderTarget[r.id],o=r.viewport||le;a.setSize(o.z*j.transmissionResolutionScale,o.w*j.transmissionResolutionScale);let s=j.getRenderTarget(),u=j.getActiveCubeFace(),d=j.getActiveMipmapLevel();j.setRenderTarget(a),j.getClearColor(fe),pe=j.getClearAlpha(),pe<1&&j.setClearColor(16777215,.5),j.clear(),ke&&Je.render(n);let f=j.toneMapping;j.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),O.setupLightsView(r),Ce===!0&&Ke.setGlobalState(j.clippingPlanes,r),yt(e,n,r),I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a),Me.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,bt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a))}j.setRenderTarget(s,u,d),j.setClearColor(fe,pe),p!==void 0&&(r.viewport=p),j.toneMapping=f}function yt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&bt(o,t,n,s,l,c)}}function bt(e,t,n,r,i,a){e.onBeforeRender(j,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(j,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=2):j.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(j,t,n,r,i,a)}function xt(e,t,n){t.isScene!==!0&&(t=Oe);let r=F.get(e),i=O.state.lights,a=O.state.shadowsArray,o=i.state.version,s=Ve.getParameters(e,i.state,a,t,n),c=Ve.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Fe.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,lt),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return Ct(e,s),d}else s.uniforms=Ve.getUniforms(e),e.onBeforeCompile(s,j),d=Ve.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ke.uniform),Ct(e,s),r.needsLights=Et(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.currentProgram=d,r.uniformsList=null,d}function St(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=hs.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function Ct(e,t){let n=F.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function wt(e,t,n,r,i){t.isScene!==!0&&(t=Oe),I.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=M===null?j.outputColorSpace:M.isXRRenderTarget===!0?M.texture.colorSpace:Be,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Fe.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(M===null||M.isXRRenderTarget===!0)&&(h=j.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=F.get(r),y=O.state.lights;if(Ce===!0&&(we===!0||e!==ce)){let t=e===ce&&r.id===se;Ke.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ke.numPlanes||v.numIntersection!==Ke.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h?v.morphTargetsCount!==_&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=xt(r,t,i));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(P.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==se&&(se=r.id,C=!0),S||ce!==e){P.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(N,`projectionMatrix`,e.projectionMatrix),T.setValue(N,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(N,Ee.setFromMatrixPosition(e.matrixWorld)),Ne.logarithmicDepthBuffer&&T.setValue(N,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(N,`isOrthographic`,e.isOrthographicCamera===!0),ce!==e&&(ce=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(N,`directionalShadowMap`,y.state.directionalShadowMap,I),y.state.spotShadowMap.length>0&&T.setValue(N,`spotShadowMap`,y.state.spotShadowMap,I),y.state.pointShadowMap.length>0&&T.setValue(N,`pointShadowMap`,y.state.pointShadowMap,I)),i.isSkinnedMesh){T.setOptional(N,i,`bindMatrix`),T.setOptional(N,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(N,`boneTexture`,e.boneTexture,I))}i.isBatchedMesh&&(T.setOptional(N,i,`batchingTexture`),T.setValue(N,`batchingTexture`,i._matricesTexture,I),T.setOptional(N,i,`batchingIdTexture`),T.setValue(N,`batchingIdTexture`,i._indirectTexture,I),T.setOptional(N,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(N,`batchingColorTexture`,i._colorsTexture,I));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Xe.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(N,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=Fc()),C&&(T.setValue(N,`toneMappingExposure`,j.toneMappingExposure),v.needsLights&&Tt(E,w),a&&r.fog===!0&&He.refreshFogUniforms(E,a),He.refreshMaterialUniforms(E,r,ge,he,O.state.transmissionRenderTarget[e.id]),hs.upload(N,St(v),E,I)),r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(hs.upload(N,St(v),E,I),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(N,`center`,i.center),T.setValue(N,`modelViewMatrix`,i.modelViewMatrix),T.setValue(N,`normalMatrix`,i.normalMatrix),T.setValue(N,`modelMatrix`,i.matrixWorld),r.isShaderMaterial||r.isRawShaderMaterial){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];it.update(n,x),it.bind(n,x)}}return x}function Tt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Et(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return ae},this.getActiveMipmapLevel=function(){return oe},this.getRenderTarget=function(){return M},this.setRenderTargetTextures=function(e,t,n){let r=F.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),F.get(e.texture).__webglTexture=t,F.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=F.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0};let Dt=N.createFramebuffer();this.setRenderTarget=function(e,t=0,n=0){M=e,ae=t,oe=n;let r=null,i=!1,a=!1;if(e){let o=F.get(e);if(o.__useDefaultFramebuffer!==void 0){P.bindFramebuffer(N.FRAMEBUFFER,o.__webglFramebuffer),le.copy(e.viewport),ue.copy(e.scissor),de=e.scissorTest,P.viewport(le),P.scissor(ue),P.setScissorTest(de),se=-1;return}else if(o.__webglFramebuffer===void 0)I.setupRenderTarget(e);else if(o.__hasExternalTextures)I.rebindTextures(e,F.get(e.texture).__webglTexture,F.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&F.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.`);I.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=F.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&I.useMultisampledRTT(e)===!1?F.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,le.copy(e.viewport),ue.copy(e.scissor),de=e.scissorTest}else le.copy(ye).multiplyScalar(ge).floor(),ue.copy(be).multiplyScalar(ge).floor(),de=xe;if(n!==0&&(r=Dt),P.bindFramebuffer(N.FRAMEBUFFER,r)&&P.drawBuffers(e,r),P.viewport(le),P.scissor(ue),P.setScissorTest(de),i){let r=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=F.get(e.textures[t]);N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,t.__webglTexture,n)}se=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){P.bindFramebuffer(N.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Ne.textureFormatReadable(c)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Ne.textureTypeReadable(l)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&N.readPixels(t,n,r,i,nt.convert(c),nt.convert(l),a)}finally{let e=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){P.bindFramebuffer(N.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Ne.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Ne.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.bufferData(N.PIXEL_PACK_BUFFER,a.byteLength,N.STREAM_READ),N.readPixels(t,n,r,i,nt.convert(l),nt.convert(u),0);let f=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,f);let p=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await tt(N,p,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,a),N.deleteBuffer(d),N.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;I.setTexture2D(e,0),N.copyTexSubImage2D(N.TEXTURE_2D,n,0,0,o,s,i,a),P.unbindTexture()};let Ot=N.createFramebuffer(),At=N.createFramebuffer();this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=nt.convert(t.format),_=nt.convert(t.type),v;t.isData3DTexture?(I.setTexture3D(t,0),v=N.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(I.setTexture2DArray(t,0),v=N.TEXTURE_2D_ARRAY):(I.setTexture2D(t,0),v=N.TEXTURE_2D),N.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,t.flipY),N.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),N.pixelStorei(N.UNPACK_ALIGNMENT,t.unpackAlignment);let y=N.getParameter(N.UNPACK_ROW_LENGTH),b=N.getParameter(N.UNPACK_IMAGE_HEIGHT),x=N.getParameter(N.UNPACK_SKIP_PIXELS),S=N.getParameter(N.UNPACK_SKIP_ROWS),C=N.getParameter(N.UNPACK_SKIP_IMAGES);N.pixelStorei(N.UNPACK_ROW_LENGTH,h.width),N.pixelStorei(N.UNPACK_IMAGE_HEIGHT,h.height),N.pixelStorei(N.UNPACK_SKIP_PIXELS,l),N.pixelStorei(N.UNPACK_SKIP_ROWS,u),N.pixelStorei(N.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=F.get(e),r=F.get(t),h=F.get(n.__renderTarget),g=F.get(r.__renderTarget);P.bindFramebuffer(N.READ_FRAMEBUFFER,h.__webglFramebuffer),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(e).__webglTexture,i,d+n),N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(t).__webglTexture,a,m+n)),N.blitFramebuffer(l,u,o,s,f,p,o,s,N.DEPTH_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||F.has(e)){let n=F.get(e),r=F.get(t);P.bindFramebuffer(N.READ_FRAMEBUFFER,Ot),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,At);for(let e=0;e<c;e++)w?N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):N.framebufferTexture2D(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,n.__webglTexture,i),T?N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):N.framebufferTexture2D(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,r.__webglTexture,a),i===0?T?N.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):N.copyTexSubImage2D(v,a,f,p,l,u,o,s):N.blitFramebuffer(l,u,o,s,f,p,o,s,N.COLOR_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?N.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h);N.pixelStorei(N.UNPACK_ROW_LENGTH,y),N.pixelStorei(N.UNPACK_IMAGE_HEIGHT,b),N.pixelStorei(N.UNPACK_SKIP_PIXELS,x),N.pixelStorei(N.UNPACK_SKIP_ROWS,S),N.pixelStorei(N.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&N.generateMipmap(v),P.unbindTexture()},this.initRenderTarget=function(e){F.get(e).__webglFramebuffer===void 0&&I.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?I.setTextureCube(e,0):e.isData3DTexture?I.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?I.setTexture2DArray(e,0):I.setTexture2D(e,0),P.unbindTexture()},this.resetState=function(){ae=0,oe=0,M=null,P.reset(),rt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ge}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=U._getDrawingBufferColorSpace(e),t.unpackColorSpace=U._getUnpackColorSpace()}};function Lc(e,t,n=16){let i=document.createElement(`canvas`);i.width=n,i.height=n;let a=i.getContext(`2d`);for(let r=0;r<n;r++)for(let i=0;i<n;i++)a.fillStyle=Math.random()>.5?`#${t.getHexString()}`:`#${e.getHexString()}`,a.fillRect(i,r,1,1);let o=new ni(i);return o.magFilter=r,o.minFilter=r,o}function Rc(e=16){let t=document.createElement(`canvas`);t.width=e,t.height=e;let n=t.getContext(`2d`),i=new W(9132587),a=new W(7029286),o=new W(5597999),s=new W(7048739);for(let t=0;t<e;t++)for(let r=0;r<e;r++){let e=t<3+Math.random()*2,c=Math.random()>.5;e?n.fillStyle=c?`#${s.getHexString()}`:`#${o.getHexString()}`:n.fillStyle=c?`#${a.getHexString()}`:`#${i.getHexString()}`,n.fillRect(r,t,1,1)}let c=new ni(t);return c.magFilter=r,c.minFilter=r,c}var X={dirt:new q({map:Lc(new W(9132587),new W(7029286))}),grassTop:new q({map:Lc(new W(5597999),new W(7048739))}),grassSide:new q({map:Rc()}),stone:new q({map:Lc(new W(7829367),new W(5592405))}),bedrock:new q({map:Lc(new W(2236962),new W(1118481))}),wood:new q({map:Lc(new W(10910720),new W(9135368))}),craftingTableTop:new q({map:Lc(new W(13468991),new W(9132587))}),leaves:new q({map:Lc(new W(3050327),new W(25600)),transparent:!0,opacity:.9}),iron_ore:new q({map:Lc(new W(7829367),new W(14199171))}),diamond_ore:new q({map:Lc(new W(7829367),new W(65535))}),gold_ore:new q({map:Lc(new W(7829367),new W(16766720))}),moonstone_ore:new q({map:Lc(new W(7829367),new W(15132410))}),etherite_ore:new q({map:Lc(new W(2236962),new W(4868698))})};function zc(e){let t=document.createElement(`canvas`);t.width=16,t.height=16;let n=t.getContext(`2d`);if(n.clearRect(0,0,16,16),e===0)return new ni(t);if(n.strokeStyle=`rgba(10, 10, 10, 0.8)`,n.lineWidth=1,n.lineCap=`square`,n.lineJoin=`miter`,n.beginPath(),[[[8,8],[5,5],[2,7],[0,4]],[[8,8],[11,6],[14,9],[16,5]],[[8,8],[9,12],[7,15],[8,16]],[[8,8],[4,10],[1,13],[0,16]],[[8,8],[12,11],[15,14],[16,16]]].forEach(t=>{n.moveTo(t[0][0],t[0][1]);let r=e/10*3;for(let e=1;e<t.length;e++)if(e<=r)n.lineTo(t[e][0],t[e][1]);else if(e-1<r){let i=r-(e-1),a=t[e-1],o=t[e];n.lineTo(a[0]+(o[0]-a[0])*i,a[1]+(o[1]-a[1])*i)}}),e>3){n.moveTo(5,5);let t=Math.min(1,(e-3)/7);n.lineTo(5+3*t,5-3*t),n.moveTo(11,6),n.lineTo(11+2*t,6-4*t)}if(e>6){n.moveTo(9,12);let t=Math.min(1,(e-6)/4);n.lineTo(9+3*t,12+2*t)}n.stroke();let i=new ni(t);return i.magFilter=r,i.minFilter=r,i}var Bc=Array.from({length:11},(e,t)=>new Cr({map:zc(t),transparent:!0,alphaTest:.1,depthWrite:!1}));function Vc(){return[X.grassSide,X.grassSide,X.grassTop,X.dirt,X.grassSide,X.grassSide]}function Hc(){return[X.wood,X.wood,X.craftingTableTop,X.wood,X.wood,X.wood]}var Uc=new ln,Wc=new K(1,1,1),Gc=new Map,Kc=new Map,qc=new Map,Jc=new Map,Yc=15e4,Xc=new Pt,Zc={grass:new Kr(Wc,Vc(),Yc),stone:new Kr(Wc,X.stone,Yc),wood:new Kr(Wc,X.wood,Yc),leaves:new Kr(Wc,X.leaves,Yc),dirt:new Kr(Wc,X.dirt,Yc),bedrock:new Kr(Wc,X.bedrock,Yc),crafting_table:new Kr(Wc,Hc(),Yc),iron_ore:new Kr(Wc,X.iron_ore,Yc),diamond_ore:new Kr(Wc,X.diamond_ore,Yc),gold_ore:new Kr(Wc,X.gold_ore,Yc),moonstone_ore:new Kr(Wc,X.moonstone_ore,Yc),etherite_ore:new Kr(Wc,X.etherite_ore,Yc)};Object.values(Zc).forEach(e=>{e.frustumCulled=!1,e.boundingSphere=new ir(new V(0,0,0),1/0)});var Qc={grass:0,stone:0,wood:0,leaves:0,dirt:0,bedrock:0,crafting_table:0,iron_ore:0,diamond_ore:0,gold_ore:0,moonstone_ore:0,etherite_ore:0},$c=``,el=new V(0,0,0);function tl(e,t=!1){el.copy(e);let n=Math.floor(e.x/16),r=Math.floor(e.z/16),i=`${n},${r}`;if(!t&&$c===i)return;$c=i;let a=Object.keys(Qc);for(let e=0;e<a.length;e++)Qc[a[e]]=0;for(let e=n-3;e<=n+3;e++)for(let t=r-3;t<=r+3;t++){let n=`${e},${t}`;ol.has(n)||sl(e,t);let r=qc.get(n);if(r)for(let e=0,t=r.length;e<t;e++){let t=r[e],n=Gc.get(`${t.x},${t.y},${t.z}`);!n||n===`air`||(Xc.makeTranslation(t.x,t.y,t.z),Zc[t.type].setMatrixAt(Qc[t.type]++,Xc))}}for(let e=0;e<a.length;e++){let t=a[e];Zc[t].count=Qc[t],Zc[t].instanceMatrix.needsUpdate=!0}}function nl(e){e.add(Uc),e.add(Zc.grass),e.add(Zc.stone),e.add(Zc.wood),e.add(Zc.leaves),e.add(Zc.dirt),e.add(Zc.bedrock),e.add(Zc.crafting_table),e.add(Zc.iron_ore),e.add(Zc.diamond_ore),e.add(Zc.gold_ore),e.add(Zc.moonstone_ore),e.add(Zc.etherite_ore),Uc.add(Zc.grass),Uc.add(Zc.stone),Uc.add(Zc.wood),Uc.add(Zc.leaves),Uc.add(Zc.dirt),Uc.add(Zc.bedrock),Uc.add(Zc.crafting_table),Uc.add(Zc.iron_ore),Uc.add(Zc.diamond_ore),Uc.add(Zc.gold_ore),Uc.add(Zc.moonstone_ore),Uc.add(Zc.etherite_ore),cl()}function rl(e,t,n,r){if(Gc.set(`${e},${t},${n}`,r),r===`air`)return;let i=`${Math.floor(e/16)},${Math.floor(n/16)}`;qc.has(i)||qc.set(i,[]),qc.get(i).push({x:e,y:t,z:n,type:r})}function il(){let e=Math.sin(0/15)*Math.cos(0/15)*5,t=Math.sin(0/5)*2+Math.cos(0/5)*2,n=Math.sin(0/3)*1;return Math.floor(e+t+n)+3.5}function al(e,t,n){let r=`${Math.round(e)},${Math.round(t)},${Math.round(n)}`;if(Gc.has(r)){let e=Gc.get(r);return e===`air`?null:e}let i=Math.sin(e/15)*Math.cos(n/15)*5,a=Math.sin(e/5)*2+Math.cos(n/5)*2,o=Math.sin((e+n)/3)*1,s=Math.floor(i+a+o);if(t<s&&t>=s-631){if(t>=s-3)return`dirt`;if(t>s-631){let r=!1;if(t<s-300){let i=Math.sin(e*91.12+t*74.233+n*101.4)*93758.5453;r=i-Math.floor(i)<.0025}if(r)return`etherite_ore`;let i=!1;if(t<s-150){let r=Math.sin(e*13.12+t*51.233+n*67.4)*55758.5453;i=r-Math.floor(r)<.005}if(i)return`moonstone_ore`;let a=!1;if(t<s-50){let r=Math.sin(e*43.12+t*18.233+n*97.4)*83758.5453;a=r-Math.floor(r)<.01}if(a)return`diamond_ore`;let o=!1;if(t<s-30){let r=Math.sin(e*12.12+t*33.233+n*11.4)*11758.5453;o=r-Math.floor(r)<.015}if(o)return`gold_ore`;let c=Math.sin(e*12.9898+t*78.233+n*37.719)*43758.5453;return c-Math.floor(c)<.05?`iron_ore`:`stone`}else return`bedrock`}return null}var ol=new Set;function sl(e,t){let n=`${e},${t}`;if(ol.has(n))return;ol.add(n);let r=e*16,i=t*16;for(let e=r;e<r+16;e++)for(let t=i;t<i+16;t++){let n=Math.sin(e/15)*Math.cos(t/15)*5,r=Math.sin(e/5)*2+Math.cos(t/5)*2,i=Math.sin((e+t)/3)*1,a=Math.floor(n+r+i);if(Kc.has(`${e},${a},${t}`)||rl(e,a,t,`grass`),Kc.has(`${e},${a-1},${t}`)||rl(e,a-1,t,`dirt`),Kc.has(`${e},${a-2},${t}`)||rl(e,a-2,t,`dirt`),Kc.has(`${e},${a-3},${t}`)||rl(e,a-3,t,`stone`),Math.random()<.01&&e%3==0&&t%3==0){if(Math.abs(e)<=3&&Math.abs(t)<=3)continue;let n=3+Math.floor(Math.random()*2);for(let r=1;r<=n;r++)Kc.has(`${e},${a+r},${t}`)||rl(e,a+r,t,`wood`);for(let r=-1;r<=1;r++)for(let i=-1;i<=1;i++)for(let o=0;o<=1;o++)o===1&&Math.abs(r)===1&&Math.abs(i)===1||r===0&&i===0&&o===0||Kc.has(`${e+r},${a+n+o},${t+i}`)||rl(e+r,a+n+o,t+i,`leaves`)}}}function cl(){tl(new V(0,0,0),!0)}function ll(e,t,n){let r=Math.round(e),i=Math.round(t),a=Math.round(n);for(let e=-1;e<=1;e++)for(let t=-1;t<=1;t++)for(let n=-1;n<=1;n++){let o=`${r+e},${i+t},${a+n}`;if(!Gc.has(o)){let o=al(r+e,i+t,a+n);o&&rl(r+e,i+t,a+n,o)}}}function ul(e,t,n){let r=null;if(n&&(r=Gc.get(n)||null),e instanceof Kr&&t!==void 0){let r=new Pt().makeScale(0,0,0).setPosition(0,-9999,0);if(e.setMatrixAt(t,r),e.instanceMatrix.needsUpdate=!0,n){Gc.set(n,`air`),Kc.set(n,`air`);let[e,t,r]=n.split(`,`).map(Number);ll(e,t,r),tl(el,!0)}}else if(Uc.remove(e),e instanceof G){let t=`${Math.round(e.position.x)},${Math.round(e.position.y)},${Math.round(e.position.z)}`;if(n&&(t=n),!r){let e=Gc.get(t)||null;r=e===`air`?null:e}Jc.delete(t),Gc.set(t,`air`),Kc.set(t,`air`)}return r}function dl(e,t=`wood`){let n=`${Math.round(e.x)},${Math.round(e.y)},${Math.round(e.z)}`,r=Gc.get(n);if((!r||r===`air`)&&!Jc.has(n)){let r=X.wood;t===`stone`&&(r=X.stone),t===`dirt`&&(r=X.dirt),t===`grass`&&(r=Vc()),t===`leaves`&&(r=X.leaves),t===`bedrock`&&(r=X.bedrock),t===`crafting_table`&&(r=Hc()),t===`iron_ore`&&(r=X.iron_ore),t===`diamond_ore`&&(r=X.diamond_ore),t===`gold_ore`&&(r=X.gold_ore),t===`moonstone_ore`&&(r=X.moonstone_ore),t===`etherite_ore`&&(r=X.etherite_ore);let i=new G(Wc,r);i.position.copy(e),Uc.add(i),Jc.set(n,i),Gc.set(n,t),Kc.set(n,t)}}var fl=[{shape:[[`wood`,`wood`],[`wood`,`wood`]],result:{type:`crafting_table`,count:1}},{shape:[[`wood`],[`wood`]],result:{type:`stick`,count:4}},{shape:[[`wood`,`wood`,`wood`],[null,`stick`,null],[null,`stick`,null]],result:{type:`wooden_pickaxe`,count:1}},{shape:[[`wood`],[`wood`],[`stick`]],result:{type:`wooden_sword`,count:1}},{shape:[[`stone`],[`stone`],[`stick`]],result:{type:`stone_sword`,count:1}},{shape:[[`wood`],[`stick`],[`stick`]],result:{type:`wooden_shovel`,count:1}},{shape:[[`stone`],[`stick`],[`stick`]],result:{type:`stone_shovel`,count:1}},{shape:[[`wood`,`wood`],[null,`stick`],[null,`stick`]],result:{type:`wooden_hoe`,count:1}},{shape:[[`wood`,`wood`],[`stick`,null],[`stick`,null]],result:{type:`wooden_hoe`,count:1}},{shape:[[`stone`,`stone`],[null,`stick`],[null,`stick`]],result:{type:`stone_hoe`,count:1}},{shape:[[`stone`,`stone`],[`stick`,null],[`stick`,null]],result:{type:`stone_hoe`,count:1}},{shape:[[`wood`,`wood`],[`wood`,`stick`],[null,`stick`]],result:{type:`wooden_axe`,count:1}},{shape:[[`wood`,`wood`],[`stick`,`wood`],[`stick`,null]],result:{type:`wooden_axe`,count:1}},{shape:[[`stone`,`stone`],[`stone`,`stick`],[null,`stick`]],result:{type:`stone_axe`,count:1}},{shape:[[`stone`,`stone`],[`stick`,`stone`],[`stick`,null]],result:{type:`stone_axe`,count:1}},{shape:[[`stone`,`stone`,`stone`],[null,`stick`,null],[null,`stick`,null]],result:{type:`stone_pickaxe`,count:1}},{shape:[[`iron_ingot`],[`iron_ingot`],[`stick`]],result:{type:`iron_sword`,count:1}},{shape:[[`iron_ingot`],[`stick`],[`stick`]],result:{type:`iron_shovel`,count:1}},{shape:[[`iron_ingot`,`iron_ingot`],[null,`stick`],[null,`stick`]],result:{type:`iron_hoe`,count:1}},{shape:[[`iron_ingot`,`iron_ingot`],[`stick`,null],[`stick`,null]],result:{type:`iron_hoe`,count:1}},{shape:[[`iron_ingot`,`iron_ingot`,`iron_ingot`],[null,`stick`,null],[null,`stick`,null]],result:{type:`iron_pickaxe`,count:1}},{shape:[[`iron_ingot`,`iron_ingot`],[`iron_ingot`,`stick`],[null,`stick`]],result:{type:`iron_axe`,count:1}},{shape:[[`iron_ingot`,`iron_ingot`],[`stick`,`iron_ingot`],[`stick`,null]],result:{type:`iron_axe`,count:1}},{shape:[[`wood`,`wood`,`wood`],[`wood`,null,`wood`]],result:{type:`wood_helmet`,count:1}},{shape:[[`wood`,null,`wood`],[`wood`,`wood`,`wood`],[`wood`,`wood`,`wood`]],result:{type:`wood_chestplate`,count:1}},{shape:[[`wood`,`wood`,`wood`],[`wood`,null,`wood`],[`wood`,null,`wood`]],result:{type:`wood_leggings`,count:1}},{shape:[[`wood`,null,`wood`],[`wood`,null,`wood`]],result:{type:`wood_boots`,count:1}},{shape:[[`iron_ingot`,`iron_ingot`,`iron_ingot`],[`iron_ingot`,null,`iron_ingot`]],result:{type:`iron_helmet`,count:1}},{shape:[[`iron_ingot`,null,`iron_ingot`],[`iron_ingot`,`iron_ingot`,`iron_ingot`],[`iron_ingot`,`iron_ingot`,`iron_ingot`]],result:{type:`iron_chestplate`,count:1}},{shape:[[`iron_ingot`,`iron_ingot`,`iron_ingot`],[`iron_ingot`,null,`iron_ingot`],[`iron_ingot`,null,`iron_ingot`]],result:{type:`iron_leggings`,count:1}},{shape:[[`iron_ingot`,null,`iron_ingot`],[`iron_ingot`,null,`iron_ingot`]],result:{type:`iron_boots`,count:1}},{shape:[[`diamond`],[`diamond`],[`stick`]],result:{type:`diamond_sword`,count:1}},{shape:[[`diamond`],[`stick`],[`stick`]],result:{type:`diamond_shovel`,count:1}},{shape:[[`diamond`,`diamond`],[null,`stick`],[null,`stick`]],result:{type:`diamond_hoe`,count:1}},{shape:[[`diamond`,`diamond`],[`stick`,null],[`stick`,null]],result:{type:`diamond_hoe`,count:1}},{shape:[[`diamond`,`diamond`,`diamond`],[null,`stick`,null],[null,`stick`,null]],result:{type:`diamond_pickaxe`,count:1}},{shape:[[`diamond`,`diamond`],[`diamond`,`stick`],[null,`stick`]],result:{type:`diamond_axe`,count:1}},{shape:[[`diamond`,`diamond`],[`stick`,`diamond`],[`stick`,null]],result:{type:`diamond_axe`,count:1}},{shape:[[`diamond`,`diamond`,`diamond`],[`diamond`,null,`diamond`]],result:{type:`diamond_helmet`,count:1}},{shape:[[`diamond`,null,`diamond`],[`diamond`,`diamond`,`diamond`],[`diamond`,`diamond`,`diamond`]],result:{type:`diamond_chestplate`,count:1}},{shape:[[`diamond`,`diamond`,`diamond`],[`diamond`,null,`diamond`],[`diamond`,null,`diamond`]],result:{type:`diamond_leggings`,count:1}},{shape:[[`diamond`,null,`diamond`],[`diamond`,null,`diamond`]],result:{type:`diamond_boots`,count:1}},{shape:[[`gold_ingot`],[`gold_ingot`],[`stick`]],result:{type:`gold_sword`,count:1}},{shape:[[`gold_ingot`],[`stick`],[`stick`]],result:{type:`gold_shovel`,count:1}},{shape:[[`gold_ingot`,`gold_ingot`],[null,`stick`],[null,`stick`]],result:{type:`gold_hoe`,count:1}},{shape:[[`gold_ingot`,`gold_ingot`],[`stick`,null],[`stick`,null]],result:{type:`gold_hoe`,count:1}},{shape:[[`gold_ingot`,`gold_ingot`,`gold_ingot`],[null,`stick`,null],[null,`stick`,null]],result:{type:`gold_pickaxe`,count:1}},{shape:[[`gold_ingot`,`gold_ingot`],[`gold_ingot`,`stick`],[null,`stick`]],result:{type:`gold_axe`,count:1}},{shape:[[`gold_ingot`,`gold_ingot`],[`stick`,`gold_ingot`],[`stick`,null]],result:{type:`gold_axe`,count:1}},{shape:[[`gold_ingot`,`gold_ingot`,`gold_ingot`],[`gold_ingot`,null,`gold_ingot`]],result:{type:`gold_helmet`,count:1}},{shape:[[`gold_ingot`,null,`gold_ingot`],[`gold_ingot`,`gold_ingot`,`gold_ingot`],[`gold_ingot`,`gold_ingot`,`gold_ingot`]],result:{type:`gold_chestplate`,count:1}},{shape:[[`gold_ingot`,`gold_ingot`,`gold_ingot`],[`gold_ingot`,null,`gold_ingot`],[`gold_ingot`,null,`gold_ingot`]],result:{type:`gold_leggings`,count:1}},{shape:[[`gold_ingot`,null,`gold_ingot`],[`gold_ingot`,null,`gold_ingot`]],result:{type:`gold_boots`,count:1}},{shape:[[`moonstone`],[`moonstone`],[`stick`]],result:{type:`moonstone_sword`,count:1}},{shape:[[`moonstone`],[`stick`],[`stick`]],result:{type:`moonstone_shovel`,count:1}},{shape:[[`moonstone`,`moonstone`],[null,`stick`],[null,`stick`]],result:{type:`moonstone_hoe`,count:1}},{shape:[[`moonstone`,`moonstone`],[`stick`,null],[`stick`,null]],result:{type:`moonstone_hoe`,count:1}},{shape:[[`moonstone`,`moonstone`,`moonstone`],[null,`stick`,null],[null,`stick`,null]],result:{type:`moonstone_pickaxe`,count:1}},{shape:[[`moonstone`,`moonstone`],[`moonstone`,`stick`],[null,`stick`]],result:{type:`moonstone_axe`,count:1}},{shape:[[`moonstone`,`moonstone`],[`stick`,`moonstone`],[`stick`,null]],result:{type:`moonstone_axe`,count:1}},{shape:[[`moonstone`,`moonstone`,`moonstone`],[`moonstone`,null,`moonstone`]],result:{type:`moonstone_helmet`,count:1}},{shape:[[`moonstone`,null,`moonstone`],[`moonstone`,`moonstone`,`moonstone`],[`moonstone`,`moonstone`,`moonstone`]],result:{type:`moonstone_chestplate`,count:1}},{shape:[[`moonstone`,`moonstone`,`moonstone`],[`moonstone`,null,`moonstone`],[`moonstone`,null,`moonstone`]],result:{type:`moonstone_leggings`,count:1}},{shape:[[`moonstone`,null,`moonstone`],[`moonstone`,null,`moonstone`]],result:{type:`moonstone_boots`,count:1}},{shape:[[`etherite`],[`etherite`],[`stick`]],result:{type:`etherite_sword`,count:1}},{shape:[[`etherite`],[`stick`],[`stick`]],result:{type:`etherite_shovel`,count:1}},{shape:[[`etherite`,`etherite`],[null,`stick`],[null,`stick`]],result:{type:`etherite_hoe`,count:1}},{shape:[[`etherite`,`etherite`],[`stick`,null],[`stick`,null]],result:{type:`etherite_hoe`,count:1}},{shape:[[`etherite`,`etherite`,`etherite`],[null,`stick`,null],[null,`stick`,null]],result:{type:`etherite_pickaxe`,count:1}},{shape:[[`etherite`,`etherite`],[`etherite`,`stick`],[null,`stick`]],result:{type:`etherite_axe`,count:1}},{shape:[[`etherite`,`etherite`],[`stick`,`etherite`],[`stick`,null]],result:{type:`etherite_axe`,count:1}},{shape:[[`etherite`,`etherite`,`etherite`],[`etherite`,null,`etherite`]],result:{type:`etherite_helmet`,count:1}},{shape:[[`etherite`,null,`etherite`],[`etherite`,`etherite`,`etherite`],[`etherite`,`etherite`,`etherite`]],result:{type:`etherite_chestplate`,count:1}},{shape:[[`etherite`,`etherite`,`etherite`],[`etherite`,null,`etherite`],[`etherite`,null,`etherite`]],result:{type:`etherite_leggings`,count:1}},{shape:[[`etherite`,null,`etherite`],[`etherite`,null,`etherite`]],result:{type:`etherite_boots`,count:1}}];function pl(e,t){let n=e.length/t,r=t,i=-1,a=n,o=-1,s=[];for(let c=0;c<n;c++){let n=[];for(let s=0;s<t;s++){let l=e[c*t+s];n.push(l),l&&(s<r&&(r=s),s>i&&(i=s),c<a&&(a=c),c>o&&(o=c))}s.push(n)}if(i===-1)return null;let c=i-r+1,l=o-a+1;for(let e of fl){let t=e.shape.length,n=e.shape[0].length;if(c!==n||l!==t)continue;let i=!0;for(let o=0;o<t;o++){for(let t=0;t<n;t++)if(s[a+o][r+t]!==e.shape[o][t]){i=!1;break}if(!i)break}if(i)return{...e.result}}return null}var Z=Array(59).fill(null),ml=0,hl=`2x2`;function gl(e){hl=e,Cl()}function _l(e){ml=e,jl()}function vl(e,t=1){for(let n=0;n<Z.length;n++){let r=Z[n];if(r&&r.type===e&&r.count<64){let e=64-r.count;if(t<=e)return r.count+=t,Al(),0;r.count=64,t-=e}}for(let n=0;n<Z.length;n++)if(!Z[n]){let r=Math.min(64,t);if(Z[n]={type:e,count:r},t-=r,t<=0)return Al(),0}return Al(),t}function yl(e,t=1){let n=Z[e];return n&&n.count>=t?(n.count-=t,n.count<=0&&(Z[e]=null),Al(),!0):!1}var bl=null,xl=null;function Sl(e,t){if(!Z[t]){e.preventDefault();return}bl=t,xl=t,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`text/plain`,t.toString())}function Cl(e=!1){let t=[],n=2;hl===`2x2`?(t.push(Z[45]?.type||null,Z[46]?.type||null),t.push(Z[48]?.type||null,Z[49]?.type||null)):(n=3,t.push(Z[45]?.type||null,Z[46]?.type||null,Z[47]?.type||null),t.push(Z[48]?.type||null,Z[49]?.type||null,Z[50]?.type||null),t.push(Z[51]?.type||null,Z[52]?.type||null,Z[53]?.type||null));let r=pl(t,n);Z[54]=r?{type:r.type,count:r.count}:null,e||Ml()}function wl(){bl=null,xl=null}function Tl(e,t,n){if(e.preventDefault(),n.classList.add(`drag-over`),bl!==null&&bl!==t){let e=t>=45&&t<=53,r=Z[bl],i=Z[t];if(e&&r&&r.count>1&&xl!==t&&(!i||i.type===r.type&&i.count<64)){xl=t,i?i.count+=1:Z[t]={type:r.type,count:1},--r.count,Ol(n,t);let e=document.querySelector(`.slot[data-index="${bl}"]`);e&&Ol(e,bl),Cl(!0);let a=document.getElementById(`crafting-result`);a&&(a.innerHTML=``,kl(a,54,!1))}}}function El(e){e.preventDefault(),e.dataTransfer.dropEffect=`move`}function Dl(e,t){if(e.preventDefault(),e.currentTarget.classList.remove(`drag-over`),bl===null||t===54)return;let n=Z[bl];if(t>=55&&t<=58&&n){let e=t===55&&n.type.endsWith(`_helmet`),r=t===56&&n.type.endsWith(`_chestplate`),i=t===57&&n.type.endsWith(`_leggings`),a=t===58&&n.type.endsWith(`_boots`);if(!e&&!r&&!i&&!a)return}if(bl===54&&t!==54){let e=Z[54];if(!e)return;let n=Z[t];if(n&&n.type!==e.type||n&&n.count+e.count>64)return;n?n.count+=e.count:Z[t]=e;let r=hl===`2x2`?[45,46,48,49]:[45,46,47,48,49,50,51,52,53];for(let e of r)Z[e]&&(--Z[e].count,Z[e].count<=0&&(Z[e]=null));Z[54]=null,Al(),Cl(),bl=null;return}if(bl!==t){let n=Z[bl],r=Z[t];if(n){let i=n.count;if(e.shiftKey?i=1:(e.ctrlKey||e.metaKey)&&(i=Math.ceil(n.count/2)),i=Math.min(i,n.count),!r)Z[t]={type:n.type,count:i},n.count-=i,n.count<=0&&(Z[bl]=null);else if(n.type===r.type){let e=64-r.count;i=Math.min(e,i),r.count+=i,n.count-=i,n.count<=0&&(Z[bl]=null)}else i===n.count&&(Z[t]=n,Z[bl]=r)}Al(),Cl()}bl=null,xl=null}function Ol(e,t){e.innerHTML=``;let n=Z[t];if(n){if(e.draggable=!0,n.type===`stick`||n.type.includes(`_`)&&n.type!==`crafting_table`){let t=document.createElement(`div`);t.className=`icon-2d item-${n.type}`,e.appendChild(t)}else{let t=document.createElement(`div`);t.className=`item-icon block-${n.type}`,[`top`,`right`,`front`].forEach(e=>{let n=document.createElement(`div`);n.className=`face ${e}`,t.appendChild(n)}),e.appendChild(t)}if(n.count>1){let t=document.createElement(`span`);t.className=`count`,t.innerText=n.count.toString(),e.appendChild(t)}}else e.draggable=!1}function kl(e,t,n){let r=document.createElement(`div`);r.className=`slot`+(n&&t===ml?` active`:``),r.dataset.index=t.toString(),r.addEventListener(`dragstart`,e=>Sl(e,t)),r.addEventListener(`dragover`,El),r.addEventListener(`drop`,e=>Dl(e,t)),r.addEventListener(`dragenter`,e=>Tl(e,t,r)),r.addEventListener(`dragleave`,()=>r.classList.remove(`drag-over`)),r.addEventListener(`dragend`,wl),Ol(r,t),e.appendChild(r)}function Al(){jl(),Ml()}function jl(){let e=document.getElementById(`inventory-bar`);if(e){e.innerHTML=``;for(let t=0;t<9;t++)kl(e,t,!0)}}function Ml(){let e=document.getElementById(`full-inventory-grid`);if(!e)return;e.innerHTML=``;for(let t=9;t<45;t++)kl(e,t,!1);for(let t=0;t<9;t++)kl(e,t,!1);let t=document.getElementById(`crafting-grid`);if(t){t.innerHTML=``,t.className=`grid-${hl}`;let e=hl===`2x2`?[45,46,48,49]:[45,46,47,48,49,50,51,52,53];for(let n of e)kl(t,n,!1)}let n=document.getElementById(`crafting-result`);n&&(n.innerHTML=``,kl(n,54,!1));let r=document.getElementById(`armor-grid`);if(r){r.innerHTML=``;for(let e=55;e<=58;e++)kl(r,e,!1)}}function Nl(){Al()}function Pl(e){for(let t=0;t<60;t++)e[t]?Z[t]={type:e[t].type,count:e[t].count}:Z[t]=null;Al()}var Fl=`dynamic`,Il=`semi`,Ll=`static`,Rl=typeof window<`u`&&`ontouchstart`in window,zl={start:`mousedown`,move:`mousemove`,end:`mouseup, mouseleave`,pressure:`webkitmouseforcechanged`},Bl,Vl;typeof window<`u`&&window.PointerEvent?Bl={start:`pointerdown`,move:`pointermove`,end:`pointerup, pointercancel, pointerleave`,pressure:`webkitmouseforcechanged`}:Rl?(Bl={start:`touchstart`,move:`touchmove`,end:`touchend, touchcancel`,pressure:`webkitmouseforcechanged`},Vl=zl):Bl=zl;var Hl=Bl,Ul=Vl,Wl=Math.PI/4,Gl=Math.PI/2,Kl=(e,t)=>{let n=t.x-e.x,r=t.y-e.y;return Math.sqrt(n*n+r*r)},ql=e=>Math.PI/180*e,Jl=e=>180/Math.PI*e,Yl=new Map,Xl=e=>{Yl.has(e)&&clearTimeout(Yl.get(e)),Yl.set(e,setTimeout(e,100))},Zl=(e,t,n)=>{let r=t.split(/[ ,]+/g);for(let t=0;t<r.length;t+=1)e.addEventListener(r[t],n,!1)},Ql=(e,t,n)=>{let r=t.split(/[ ,]+/g);for(let t=0;t<r.length;t+=1)e.removeEventListener(r[t],n)},$l=e=>`force`in e?e.force:`pressure`in e?e.pressure:`webkitForce`in e?e.webkitForce/3:+(`buttons`in e&&e.buttons!==0),eu=(e,t)=>({identifier:`identifier`in t?t.identifier:`pointerId`in t?t.pointerId:1,isTouch:`touches`in e||`changedTouches`in e,position:{x:t.pageX,y:t.pageY},pressure:$l(t),type:e.type,initial:e,raw:t}),tu=()=>({x:window.scrollX,y:window.scrollY}),nu=(e,t)=>{let{left:n,top:r,right:i,bottom:a,x:o,y:s}=t;r||i||a||n?iu(e.style,{top:r,right:i,bottom:a,left:n}):(au(o)||au(s))&&iu(e.style,{left:au(o)?`${o}px`:void 0,top:au(s)?`${s}px`:void 0})},ru=(e,t=``)=>({[e]:t}),iu=(e,t)=>{for(let n in t)Object.hasOwn(t,n)&&(e[n]=t[n]);return e},au=e=>typeof e==`number`&&!isNaN(e),ou={debug:0,info:1,warning:2,error:3,none:4},su=`warning`,cu=class{constructor(e){this.uid=0,this.index=0,this.name=`super`,this._domHandlers_=new Map,this._handlers_={},this.name=e,this.log(`construct`,this.name,this.index)}mapOnEvents(e,t){let n=e.split(/[ ,]+/g);for(let e=0;e<n.length;e+=1)t(n[e])}on(e,t){this.mapOnEvents(e,(e=>{this._handlers_[e]=this._handlers_[e]||new Set,this._handlers_[e].add(t)}))}off(e,t){e===void 0?this._handlers_={}:this.mapOnEvents(e,(e=>{t===void 0?this._handlers_[e]=new Set:this._handlers_[e]&&this._handlers_[e].delete(t)}))}trigger(e,t){this.mapOnEvents(e,(e=>{this.log(`- "${e}" [trigger]`);let n=this._handlers_[e];if(n&&n.size){let r=[...n];for(let n of r)n.call(this,{type:e,target:this,data:t})}}))}bindEvt(e,t,n){let r=e=>{for(let r of(e=>{e.type.toLowerCase().includes(`move`)&&e.preventDefault();let t=[];if(`changedTouches`in e)for(let n of e.changedTouches)n&&t.push(n);else t.push(e);return t.map((t=>eu(e,t)))})(e))this.log(`- "${t}" [dom:trigger:${r.identifier}]`),n.call(this,r)};this._domHandlers_.set(n,r),Zl(e,Hl[t],r),Ul?.[t]&&Zl(e,Ul[t],r)}unbindEvt(e,t,n){let r=this._domHandlers_.get(n);r?(Ql(e,Hl[t],r),Ul?.[t]&&Ql(e,Ul[t],r),this._domHandlers_.delete(n)):this.error(`Internal handler not found for event ${t}.`,n)}logPrefix(){return{super:``,joystick:`  `,collection:`    `,factory:`      `}[this.name]}logSuffix(){return`[${this.name}|${this.uid}]`}static get logLevel(){return su}static set logLevel(e){su=e}log(...e){ou[su]<=ou.debug&&console.log(this.logPrefix(),...e,this.logSuffix())}info(...e){ou[su]<=ou.info&&console.info(this.logPrefix(),...e,this.logSuffix())}warn(...e){ou[su]<=ou.warning&&console.warn(this.logPrefix(),...e,this.logSuffix())}error(...e){ou[su]<=ou.error&&console.error(this.logPrefix(),...e,this.logSuffix())}},lu=class e extends cu{constructor(t,n){super(`joystick`),this.direction={},this.defaults={size:100,threshold:.1,color:`white`,fadeTime:250,dataOnly:!1,restJoystick:!0,restOpacity:.5,mode:`dynamic`,zone:document.body,lockX:!1,lockY:!1,shape:`circle`},this.position=n.position,this.frontPosition=n.frontPosition,this.collection=t,this.options={...this.defaults,...n},this.options.mode===`dynamic`&&(this.options.restOpacity=0),this.uid=e.index++,this.ui={el:document.createElement(`div`),back:document.createElement(`div`),front:document.createElement(`div`)}}init(){this.options.dataOnly||this.buildEl(),this.trigger(`added`,this),this.trigger(`joystickCreated`,this)}get identifier(){return this._identifier}set identifier(e){au(e)?(this._identifier=e,this.trigger(`attached`,{collection:this.collection,joystick:this,identifier:e})):(this.trigger(`detached`,{collection:this.collection,joystick:this,identifier:this._identifier}),this._identifier=void 0)}resolveColors(){let e=this.options.color;return typeof e==`object`&&e?e:{front:e,back:e}}buildEl(){this.ui.el.className=`joystick collection_${this.collection.uid}`,this.ui.back.className=`back`,this.ui.front.className=`front`,this.ui.el.setAttribute(`id`,`joystick_${this.collection.uid}_${this.uid}`),this.ui.el.appendChild(this.ui.back),this.ui.el.appendChild(this.ui.front);let e=`${this.options.fadeTime}ms`,t=ru(`borderRadius`,`50%`),n=ru(`transition`,`opacity ${e}`),r=this.resolveColors();iu(this.ui.el.style,{position:`absolute`,opacity:this.options.restOpacity.toString(),display:`block`,zIndex:`999`,...n}),iu(this.ui.back.style,{position:`absolute`,display:`block`,width:`${this.options.size}px`,height:`${this.options.size}px`,left:`0`,marginLeft:-this.options.size/2+`px`,marginTop:-this.options.size/2+`px`,background:r.back,...this.options.shape===`circle`?t:{}}),iu(this.ui.front.style,{width:this.options.size/2+`px`,height:this.options.size/2+`px`,position:`absolute`,display:`block`,left:`0`,marginLeft:-this.options.size/4+`px`,marginTop:-this.options.size/4+`px`,background:r.front,opacity:`.5`,transform:`translate(0px, 0px)`,...t})}get pressure(){return this._pressure??0}set pressure(e){e!==this._pressure&&(this._pressure=e,this.trigger(`pressure`,e))}startPressureInterval(e){this.pressureInterval||=window.setInterval((()=>{this.pressure=$l(e)}),100)}stopPressureInterval(){clearInterval(this.pressureInterval),this.pressureInterval=void 0}addToDom(){this.options.dataOnly||document.body.contains(this.ui.el)||this.options.zone.appendChild(this.ui.el)}removeFromDom(){!this.options.dataOnly&&document.body.contains(this.ui.el)&&this.options.zone.removeChild(this.ui.el)}clearTimeouts(){clearTimeout(this.removeTimeout),clearTimeout(this.showTimeout),clearTimeout(this.restTimeout),clearTimeout(this.activeTimeout),this.removeTimeout=void 0,this.showTimeout=void 0,this.restTimeout=void 0,this.activeTimeout=void 0}start(e,t){this.trigger(`start`,this),this.clearTimeouts(),this.options.dataOnly?typeof t==`function`&&t.call(this):(this.addToDom(),this.startPressureInterval(e),requestAnimationFrame((()=>{this.ui.el.style.opacity=`1`})),this.showTimeout=window.setTimeout((()=>{this.showTimeout=void 0,this.trigger(`shown`,this),typeof t==`function`&&t.call(this)}),this.options.fadeTime))}end(e){if(this.resetDirection(),this.clearTimeouts(),this.stopPressureInterval(),this.pressure=0,this.trigger(`end`,this),this.options.dataOnly)typeof e==`function`&&e.call(this);else{if(this.ui.el.style.opacity=this.options.restOpacity.toString(),this.options.restJoystick){let t=this.options.restJoystick,n={x:!0===t||!1!==t.x?0:this.frontPosition.x,y:!0===t||!1!==t.y?0:this.frontPosition.y};this.setPosition(e,n)}clearTimeout(this.removeTimeout),this.removeTimeout=window.setTimeout((()=>{this.removeTimeout=void 0,this.ui.el.style.display=this.options.mode===Fl?`none`:`block`,this.trigger(`hidden`,this),this.options.mode===Fl&&(this.trigger(`removed`,this),this.destroy()),typeof e==`function`&&e.call(this)}),this.options.fadeTime)}}setTransition(e=!1,t){if(e){let e=iu(ru(`transition`,`transform 100ms`),ru(`transform`,`translate(${this.frontPosition.x}px, ${this.frontPosition.y}px)`));iu(this.ui.front.style,e),clearTimeout(this.activeTimeout),this.activeTimeout=window.setTimeout((()=>{this.activeTimeout=void 0,typeof t==`function`&&t.call(this)}),100)}else iu(this.ui.front.style,ru(`transition`,`none`))}setPosition(e,t){this.frontPosition={x:t.x,y:t.y},this.setTransition(!0),clearTimeout(this.restTimeout),this.restTimeout=window.setTimeout((()=>{this.restTimeout=void 0,typeof e==`function`&&e.call(this),this.setTransition(!1),this.trigger(`rested`,this)}),this.options.fadeTime)}resetDirection(){this.direction={}}computeDirectionAndTriggerEvents(e){let t=e.angle.radian,n={};return t>Wl&&t<3*Wl&&!e.lockX?n.angle=`up`:t>-Wl&&t<=Wl&&!e.lockY?n.angle=`left`:t>3*-Wl&&t<=-Wl&&!e.lockX?n.angle=`down`:e.lockY||(n.angle=`right`),e.lockY||(n.x=t>-Gl&&t<Gl?`left`:`right`),e.lockX||(n.y=t>0?`up`:`down`),e.angle={radian:ql(180-e.angle.degree),degree:180-e.angle.degree},this.triggerDirectionEvents(e,n),e}triggerDirectionEvents(e,t){if(e.force>this.options.threshold){let n={x:this.direction.x,y:this.direction.y,angle:this.direction.angle};this.direction=t,e.direction=t,n.x!==t.x&&this.trigger(`plain plain:${t.x}`,e),n.y!==t.y&&this.trigger(`plain plain:${t.y}`,e),n.angle!==t.angle&&this.trigger(`dir dir:${t.angle}`,e)}else this.resetDirection();this.trigger(`move`,e)}destroy(){this.clearTimeouts(),this.identifier=void 0,this.removeFromDom(),this.trigger(`joystickDestroyed`,this),this.off()}};lu.index=0;var uu=lu,du=class e extends cu{constructor(t,n){super(`collection`),this.all=new Map,this.idles=new Set,this.actives=new Map,this.resting=new Map,this.parentIsFlex=!1,this.defaults={catchDistance:200,color:`white`,dataOnly:!1,dynamicPage:!1,fadeTime:250,follow:!1,lockX:!1,lockY:!1,maxNumberOfJoysticks:10,mode:Fl,multitouch:!1,position:{top:`0px`,left:`0px`},restJoystick:!0,restOpacity:.5,shape:`circle`,size:100,threshold:.1,zone:document.body},this.factory=t,this.uid=e.index++,this.options={...this.defaults,...n},this.options.mode!==Ll&&this.options.mode!==Il||(this.options.multitouch=!1),this.options.multitouch||(this.options.maxNumberOfJoysticks=1),(this.options.zone.parentElement&&getComputedStyle(this.options.zone.parentElement))?.display===`flex`&&(this.parentIsFlex=!0),getComputedStyle(this.options.zone).position===`static`&&this.warn(`The zone element has no CSS "position" set (it is "static").`,`Joysticks may not be positioned correctly.`,`Set "position: relative" (or absolute/fixed) on the zone element.`),this.box=this.options.zone.getBoundingClientRect(),this.bindEvt(this.options.zone,`start`,this.processOnStart),iu(this.options.zone.style,{touchAction:`none`,userSelect:`none`,webkitUserSelect:`none`}),typeof ResizeObserver<`u`&&(this.resizeObserver=new ResizeObserver((()=>{this.reposition()})),this.resizeObserver.observe(this.options.zone))}init(){this.trigger(`collectionCreated`,this),this.options.mode===Ll&&this.createJoystick(this.options.position).addToDom()}getJoystickByUid(e){return e===void 0?this.all.values().next().value:this.all.get(e)}bindJoystick(e){e.on(`joystickDestroyed`,(()=>{this.deleteJoystickFromLists(e)})),e.on(`attached`,(t=>{this.idles.delete(t.data.joystick.uid),this.actives.set(t.data.identifier,e)})),e.on(`detached`,(e=>{this.idles.add(e.data.joystick.uid),this.deleteIdentifierFromLists(e.data.identifier)})),e.on(`end`,(t=>{au(t.data.identifier)&&(this.actives.delete(t.data.identifier),this.resting.set(t.data.identifier,e))})),e.on(`hidden`,(e=>{au(e.data.identifier)&&this.resting.delete(e.data.identifier),this.idles.add(e.data.uid)})),e.on(`pressure`,(t=>{this.trigger(`pressure ${e.uid}:pressure`,t.data)})),e.on(`attached detached`,(e=>{let t=`${e.type} ${e.data.joystick.uid}:${e.type}`;this.trigger(t,e.data)})),e.on(`added start shown hidden rested removed end joystickCreated joystickDestroyed`,(e=>{let t=`${e.type} ${e.data.uid}:${e.type}`;this.trigger(t,e.data)})),e.on(`move`,(e=>{this.trigger(`move ${e.data.instance.uid}:move`,e.data)})),e.on(`dir dir:up dir:right dir:down dir:left`,(e=>{let t=`${e.type} ${e.data.instance.uid}:${e.type}`;this.trigger(t,e.data)})),e.on(`plain plain:up plain:right plain:down plain:left`,(e=>{let t=`${e.type} ${e.data.instance.uid}:${e.type}`;this.trigger(t,e.data)}))}deleteJoystickFromLists(e){this.deleteUidFromLists(e.uid),au(e.identifier)&&this.deleteIdentifierFromLists(e.identifier)}deleteUidFromLists(e){this.all.delete(e),this.idles.delete(e)}deleteIdentifierFromLists(e){this.actives.delete(e),this.resting.delete(e)}getOrCreate(e){if(this.options.mode===Il||this.options.mode===Ll){let t=this.idles.values().next().value;if(au(t)){let e=this.all.get(t);if(e)return e;this.error(`Couldn't find the joystick ${t}. Creating a new one.`),this.deleteUidFromLists(t)}if(this.options.mode===Il)return this.createJoystick(e);this.warn(`Couldn't find the expected joystick. Creating a new one.`)}return this.createJoystick(e)}createJoystick(e){let t=this.factory.scroll,n=this.parentIsFlex?t.x:t.x+this.box.left,r=this.parentIsFlex?t.y:t.y+this.box.top,i,a;if(au(e.x)&&au(e.y))i={x:e.x-n,y:e.y-r},a={x:e.x,y:e.y};else{if(!(e.top||e.right||e.bottom||e.left))return void this.error(`Invalid or missing position.`,e);{let n=document.createElement(`DIV`);iu(n.style,{visibility:`hidden`,position:`absolute`,top:e.top,right:e.right,bottom:e.bottom,left:e.left}),this.options.zone.appendChild(n);let r=n.getBoundingClientRect();this.options.zone.removeChild(n),i=e,a={x:r.left+t.x,y:r.top+t.y}}}let o=new uu(this,{color:this.options.color,size:this.options.size,threshold:this.options.threshold,fadeTime:this.options.fadeTime,dataOnly:this.options.dataOnly,restJoystick:this.options.restJoystick,restOpacity:this.options.restOpacity,mode:this.options.mode,position:a,zone:this.options.zone,frontPosition:{x:0,y:0},shape:this.options.shape});return this.all.has(o.uid)&&this.error(`Joystick with uid ${o.uid} already exists.`),this.options.dataOnly||(nu(o.ui.el,i),nu(o.ui.front,o.frontPosition)),this.all.set(o.uid,o),this.idles.add(o.uid),this.bindJoystick(o),o.init(),o}processOnStart(e,t=0){if(this.box=this.options.zone.getBoundingClientRect(),!this.actives.has(e.identifier)&&this.actives.size>=this.options.maxNumberOfJoysticks)return void this.warn(`No more joysticks allowed.`);let n=this.actives.get(e.identifier)||this.resting.get(e.identifier)||this.getOrCreate(e.position),r=()=>{n.start(e.raw),n.identifier=e.identifier,this.processOnMove(e,!0)};this.options.mode===Il?Kl(e.position,n.position)<=this.options.catchDistance?r():t<3?(n.destroy(),this.processOnStart(e,t+1)):this.error(`Max semi-mode recursion depth reached.`):r()}processOnMove(e,t=!1){let n=this.actives.get(e.identifier),r=this.factory.scroll;if(!n)return this.error(`Found zombie joystick onMove with identifier ${e.identifier}`),void this.deleteIdentifierFromLists(e.identifier);this.options.dynamicPage&&this.reposition();let i=n.options.size/2,a={x:e.position.x,y:e.position.y};this.options.lockX&&(a.y=n.position.y),this.options.lockY&&(a.x=n.position.x);let o=Kl(a,n.position),s=((e,t)=>{let n=t.x-e.x,r=t.y-e.y;return Jl(Math.atan2(r,n))})(a,n.position),c=ql(s),l=o/i,u={distance:o,position:a},d,f;n.options.shape===`circle`?(d=Math.min(o,i),f=((e,t,n)=>{let r=ql(n);return{x:e.x-t*Math.cos(r),y:e.y-t*Math.sin(r)}})(n.position,d,s)):(f=((e,t,n)=>({x:Math.min(Math.max(e.x,t.x-n),t.x+n),y:Math.min(Math.max(e.y,t.y-n),t.y+n)}))(a,n.position,i),d=Kl(f,n.position));let p={x:0,y:0};if(this.options.follow){if(o>i){let e=a.x-f.x,t=a.y-f.y;p={x:e,y:-t},n.position.x+=e,n.position.y+=t,iu(n.ui.el.style,{top:n.position.y-(this.box.top+r.y)+`px`,left:n.position.x-(this.box.left+r.x)+`px`}),o=Kl(a,n.position)}}else a=f,o=d;let m=a.x-n.position.x,h=a.y-n.position.y;n.frontPosition={x:m,y:h},this.options.dataOnly||(t&&n.setTransition(!0,(()=>{n.setTransition(!1)})),n.ui.front.style.transform=`translate(${m}px,${h}px)`);let g={position:a,force:l,pressure:e.pressure,distance:o,angle:{radian:c,degree:s},vector:{x:m/i,y:-h/i},raw:u,instance:n,lockX:this.options.lockX,lockY:this.options.lockY,baseDelta:p};n.computeDirectionAndTriggerEvents(g)}processOnEnd(e){let t=this.actives.get(e.identifier);if(!t)return this.error(`Found zombie joystick onEnd with identifier ${e.identifier}`),void this.deleteIdentifierFromLists(e.identifier);t.end()}reposition(){this.factory.scroll=tu(),this.box=this.options.zone.getBoundingClientRect();let e=this.factory.scroll;this.all.forEach((t=>{if(t.options.dataOnly)return;let n=t.ui.el.getBoundingClientRect();t.position={x:e.x+n.left,y:e.y+n.top}}))}destroy(){this.resizeObserver&&=(this.resizeObserver.disconnect(),void 0),this.unbindEvt(this.options.zone,`start`,this.processOnStart),this.all.forEach((e=>{e.destroy()})),this.all.clear(),this.idles.clear(),this.actives.clear(),this.resting.clear(),this.trigger(`collectionDestroyed`,this),this.off()}};du.index=0;var fu=du,pu=new class extends cu{constructor(){super(`factory`),this.scroll=tu(),this.binded=!1,this.joysticksByUid=new Map,this.joysticksByIdentifier=new Map,this.collections=new Set,this.resizeHandler=null,this.scrollHandler=null,this.repositionAll=()=>{this.collections.forEach((e=>{e.reposition()}))},this.refreshScroll=()=>{this.scroll=tu()},this.bindResize(),this.bindScroll(),this.trigger(`factoryCreated`,this)}bindResize(){this.resizeHandler=()=>Xl(this.repositionAll),Zl(window,`resize`,this.resizeHandler)}bindScroll(){this.scrollHandler=()=>Xl(this.refreshScroll),Zl(window,`scroll`,this.scrollHandler)}getJoystickByUid(e){return this.joysticksByUid.get(e)}getJoystickByIdentifier(e){return this.joysticksByIdentifier.get(e)}create(e){let t=new fu(this,e);return this.bindCollection(t),this.collections.add(t),t.init(),t}removeJoystickFromLists(e){this.joysticksByUid.delete(e.uid),au(e.identifier)&&this.joysticksByIdentifier.delete(e.identifier)}bindCollection(e){e.on(`collectionDestroyed`,(e=>{this.collections.delete(e.data),e.data.all.forEach((e=>{this.removeJoystickFromLists(e)})),this.unbindDocument()})),e.on(`joystickDestroyed`,(e=>{this.removeJoystickFromLists(e.data),this.unbindDocument()})),e.on(`end`,(e=>{au(e.data.identifier)&&this.joysticksByIdentifier.delete(e.data.identifier),this.unbindDocument()})),e.on(`added`,(e=>{this.joysticksByUid.set(e.data.uid,e.data),this.bindDocument()})),e.on(`attached`,(e=>{this.joysticksByIdentifier.set(e.data.identifier,e.data.joystick)})),e.on(`pressure`,(e=>{this.trigger(`pressure ${e.target.uid}:pressure`,e.data)})),e.on(`collectionCreated collectionDestroyed`,(e=>{let t=`${e.type} ${e.data.uid}:${e.type}`;this.trigger(t,e.data)})),e.on(`attached detached`,(e=>{let t=`${e.type} ${e.data.joystick.uid}:${e.type}`;this.trigger(t,e.data)})),e.on(`added start shown hidden rested removed end joystickCreated joystickDestroyed`,(e=>{let t=`${e.type} ${e.data.uid}:${e.type}`;this.trigger(t,e.data)})),e.on(`move`,(e=>{this.trigger(`move ${e.data.instance.uid}:move`,e.data)})),e.on(`dir dir:up dir:right dir:down dir:left`,(e=>{let t=`${e.type} ${e.data.instance.uid}:${e.type}`;this.trigger(t,e.data)})),e.on(`plain plain:up plain:right plain:down plain:left`,(e=>{let t=`${e.type} ${e.data.instance.uid}:${e.type}`;this.trigger(t,e.data)}))}cleanInactiveTouches(e){let t=`touches`in e.initial?Array.from(e.initial.touches).map((e=>e.identifier)):[e.identifier];this.log(`Cleaning inactive`,t,Array.from(this.joysticksByIdentifier.keys()));for(let[n,r]of this.joysticksByIdentifier)if(r.collection.options.mode===Fl&&!t.includes(n)){if(!r)return void this.error(`No collection found for cleaning identifier ${n}`);this.log(`💣 Cleaning`,n);let t=e.raw;r.collection.processOnEnd(eu(e.initial,{identifier:n,pageX:t.pageX,pageY:t.pageY,clientX:t.clientX,clientY:t.clientY}))}}bindDocument(){this.binded||=(this.log(`bind dom`),this.bindEvt(document,`start`,this.onstart),this.bindEvt(document,`move`,this.onmove),this.bindEvt(document,`end`,this.onend),this.bindEvt(document,`pressure`,this.onpressure),!0)}unbindDocument(e=!1){!this.binded||this.joysticksByUid.size&&!0!==e||(this.log((e?`force `:``)+`unbind dom`),this.unbindEvt(document,`start`,this.onstart),this.unbindEvt(document,`move`,this.onmove),this.unbindEvt(document,`end`,this.onend),this.unbindEvt(document,`pressure`,this.onpressure),this.binded=!1)}onstart(e){this.cleanInactiveTouches(e)}onmove(e){this.handleEventInCollection(e,(t=>{t.processOnMove(e)}))}onend(e){this.cleanInactiveTouches(e),this.handleEventInCollection(e,(t=>{t.processOnEnd(e)}))}onpressure(e){e.initial.preventDefault();let t=this.joysticksByIdentifier.get(e.identifier);t?t.pressure=e.pressure:this.error(`No joystick found for pressure event ${e.identifier}`)}handleEventInCollection(e,t){let n=this.joysticksByIdentifier.get(e.identifier);n&&t(n.collection)}destroy(){this.unbindDocument(!0),this.collections.forEach((e=>{e.destroy()})),this.resizeHandler&&=(Ql(window,`resize`,this.resizeHandler),null),this.scrollHandler&&=(Ql(window,`scroll`,this.scrollHandler),null),this.trigger(`factoryDestroyed`,this),this.off()}},mu={create:e=>pu.create(e),factory:pu,setLogLevel:e=>{cu.logLevel=e},getLogLevel:()=>cu.logLevel},hu=(()=>{let e=`ontouchstart`in window||navigator.maxTouchPoints>0,t=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);return e&&(t||window.innerWidth<=1366)})(),gu={x:0,y:0},Q={forward:!1,backward:!1,left:!1,right:!1,run:!1,jump:!1,shift:!1};function _u(){if(hu){vu();return}document.addEventListener(`keydown`,e=>{switch(e.code){case`ArrowUp`:case`KeyW`:Q.forward=!0;break;case`ArrowLeft`:case`KeyA`:Q.left=!0;break;case`ArrowDown`:case`KeyS`:Q.backward=!0;break;case`ArrowRight`:case`KeyD`:Q.right=!0;break;case`KeyR`:Q.run=!0;break;case`Space`:Q.jump=!0;break;case`ShiftLeft`:case`ShiftRight`:Q.shift=!0;break;case`Digit1`:_l(0);break;case`Digit2`:_l(1);break;case`Digit3`:_l(2);break;case`Digit4`:_l(3);break;case`Digit5`:_l(4);break;case`Digit6`:_l(5);break;case`Digit7`:_l(6);break;case`Digit8`:_l(7);break;case`Digit9`:_l(8);break}}),document.addEventListener(`keyup`,e=>{switch(e.code){case`ArrowUp`:case`KeyW`:Q.forward=!1;break;case`ArrowLeft`:case`KeyA`:Q.left=!1;break;case`ArrowDown`:case`KeyS`:Q.backward=!1;break;case`ArrowRight`:case`KeyD`:Q.right=!1;break;case`KeyR`:Q.run=!1;break;case`Space`:Q.jump=!1;break;case`ShiftLeft`:case`ShiftRight`:Q.shift=!1;break}})}function vu(){let e=document.getElementById(`mobile-hud`);e&&(e.style.display=`block`);let t=document.getElementById(`joystick-zone`);if(t){let e=mu.create({zone:t,mode:`static`,position:{left:`50%`,top:`50%`},color:`white`});e.on(`move`,(e,t)=>{let n=t.angle.degree;Q.forward=n>45&&n<135,Q.backward=n>225&&n<315,Q.right=n<=45||n>=315,Q.left=n>=135&&n<=225}),e.on(`end`,()=>{Q.forward=!1,Q.backward=!1,Q.left=!1,Q.right=!1})}let n=document.getElementById(`touch-look-zone`),r=0,i=0;n&&(n.addEventListener(`touchstart`,e=>{r=e.touches[0].clientX,i=e.touches[0].clientY}),n.addEventListener(`touchmove`,e=>{let t=e.touches[0];gu.x=t.clientX-r,gu.y=t.clientY-i,r=t.clientX,i=t.clientY}),n.addEventListener(`touchend`,()=>{gu.x=0,gu.y=0}));let a=(e,t)=>{let n=document.getElementById(e);n&&(n.addEventListener(`touchstart`,e=>{e.preventDefault(),e.stopPropagation(),t(!0)},{passive:!1}),n.addEventListener(`touchend`,e=>{e.preventDefault(),e.stopPropagation(),t(!1)},{passive:!1}),n.addEventListener(`touchcancel`,e=>{e.preventDefault(),e.stopPropagation(),t(!1)},{passive:!1}))};a(`btn-mobile-jump`,e=>Q.jump=e),a(`btn-mobile-sprint`,e=>Q.run=e),a(`btn-mobile-sneak`,e=>Q.shift=e),a(`btn-mobile-hit`,e=>{e?document.dispatchEvent(new MouseEvent(`mousedown`,{button:0})):document.dispatchEvent(new MouseEvent(`mouseup`,{button:0}))}),a(`btn-mobile-place`,e=>{e&&(document.dispatchEvent(new MouseEvent(`mousedown`,{button:0})),setTimeout(()=>{document.dispatchEvent(new MouseEvent(`mouseup`,{button:0}))},50))}),a(`btn-mobile-inv`,e=>{e&&document.dispatchEvent(new KeyboardEvent(`keydown`,{code:`KeyI`}))}),a(`btn-mobile-shop`,e=>{if(e){let e=document.getElementById(`btn-shop`);e&&e.click()}}),a(`btn-mobile-menu`,e=>{if(e){let e=document.getElementById(`main-menu`),t=document.getElementById(`menu-screen-main`);e&&(e.style.display===`none`?(e.style.display=`flex`,t&&(t.style.display=`flex`)):e.style.display=`none`)}}),a(`btn-mobile-save`,e=>{if(e){let e=document.getElementById(`btn-save-quit`);e&&e.click()}}),document.body.addEventListener(`touchmove`,e=>{e.target?.closest(`#full-inventory-modal, #shop-screen, #main-menu`)||e.preventDefault()},{passive:!1})}var yu=new Wt(0,0,0,`YXZ`),bu=new V,xu={type:`change`},Su={type:`lock`},Cu={type:`unlock`},wu=.002,Tu=Math.PI/2,Eu=class extends va{constructor(e,t=null){super(e,t),this.isLocked=!1,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.pointerSpeed=1,this._onMouseMove=Du.bind(this),this._onPointerlockChange=Ou.bind(this),this._onPointerlockError=ku.bind(this),this.domElement!==null&&this.connect(this.domElement)}connect(e){super.connect(e),this.domElement.ownerDocument.addEventListener(`mousemove`,this._onMouseMove),this.domElement.ownerDocument.addEventListener(`pointerlockchange`,this._onPointerlockChange),this.domElement.ownerDocument.addEventListener(`pointerlockerror`,this._onPointerlockError)}disconnect(){this.domElement.ownerDocument.removeEventListener(`mousemove`,this._onMouseMove),this.domElement.ownerDocument.removeEventListener(`pointerlockchange`,this._onPointerlockChange),this.domElement.ownerDocument.removeEventListener(`pointerlockerror`,this._onPointerlockError)}dispose(){this.disconnect()}getDirection(e){return e.set(0,0,-1).applyQuaternion(this.object.quaternion)}moveForward(e){if(this.enabled===!1)return;let t=this.object;bu.setFromMatrixColumn(t.matrix,0),bu.crossVectors(t.up,bu),t.position.addScaledVector(bu,e)}moveRight(e){if(this.enabled===!1)return;let t=this.object;bu.setFromMatrixColumn(t.matrix,0),t.position.addScaledVector(bu,e)}lock(e=!1){this.domElement.requestPointerLock({unadjustedMovement:e})}unlock(){this.domElement.ownerDocument.exitPointerLock()}};function Du(e){if(this.enabled===!1||this.isLocked===!1)return;let t=this.object;yu.setFromQuaternion(t.quaternion),yu.y-=e.movementX*wu*this.pointerSpeed,yu.x-=e.movementY*wu*this.pointerSpeed,yu.x=Math.max(Tu-this.maxPolarAngle,Math.min(Tu-this.minPolarAngle,yu.x)),t.quaternion.setFromEuler(yu),this.dispatchEvent(xu)}function Ou(){this.domElement.ownerDocument.pointerLockElement===this.domElement?(this.dispatchEvent(Su),this.isLocked=!0):(this.dispatchEvent(Cu),this.isLocked=!1)}function ku(){console.error(`THREE.PointerLockControls: Unable to use Pointer Lock API`)}document.addEventListener(`contextmenu`,e=>e.preventDefault());var $,Au,ju=new V,Mu=new V,Nu=performance.now(),Pu=[],Fu=0,Iu=!1,Lu=0,Ru=!1,zu=!1,Bu=null,Vu=600,Hu=new B(0,0),Uu=new V,Wu=new Pt,Gu=new G(new K(1.002,1.002,1.002),Bc[0]);Gu.visible=!1;function Ku(e){let t=.6,n=.6,r=e.y-1.75,i=e.y+.25,a=Math.floor(e.x-t/2+.5),o=Math.floor(e.x+t/2+.5),s=Math.floor(r+.5),c=Math.floor(i+.5),l=Math.floor(e.z-n/2+.5),u=Math.floor(e.z+n/2+.5);for(let e=a;e<=o;e++)for(let t=s;t<=c;t++)for(let n=l;n<=u;n++)if(al(e,t,n)||Jc.has(`${e},${t},${n}`))return!0;return!1}function qu(e){let t=$.object.position,n=.6,r=.6,i=t.y-1.75,a=t.y+.25,o=t.x-n/2,s=t.x+n/2,c=i,l=a,u=t.z-r/2,d=t.z+r/2,f=e.x-.5,p=e.x+.5,m=e.y-.5,h=e.y+.5,g=e.z-.5,_=e.z+.5;return o<p&&s>f&&c<h&&l>m&&u<_&&d>g}var Ju,Yu,Xu,Zu=0,Qu,$u,ed,td=localStorage.getItem(`poxel_skin`)||`#ffcc99`,nd=localStorage.getItem(`poxel_shirt`)||`#00aaff`,rd=localStorage.getItem(`poxel_pants`)||`#0000aa`,id=new q({color:nd}),ad=new q({color:td}),od=new q({color:rd}),sd=new q({color:localStorage.getItem(`poxel_hair`)||`#6b4423`}),cd=localStorage.getItem(`poxel_eye`)||`#000000`,ld=parseInt(localStorage.getItem(`poxel_style`)||`0`),ud=new Cr({color:cd}),dd=new Cr({color:cd});function fd(e,t){e===0?(t.geometry=new K(.52,.1,.52),t.position.set(0,.22,0)):e===1?(t.geometry=new K(.4,.25,.4),t.position.set(0,.35,0)):e===2&&(t.geometry=new K(.52,.3,.52),t.position.set(0,.35,0))}var pd,md,hd;function gd(e,t,n,r,i,a,o){if(e&&ad.color.set(e),t&&id.color.set(t),n&&od.color.set(n),r&&sd.color.set(r),i&&(ud.color.set(i),dd.color.set(i)),a!==void 0&&Qu&&fd(a,Qu),o!==void 0&&Sd&&Cd){if(!pd){pd=new G(new oi(.2,.2,.4),new q({color:1118481}));let e=new G(new oi(.35,.35,.05),new q({color:1118481}));e.position.y=-.2,pd.add(e),pd.position.y=.45,Sd.add(pd),md=new G(new K(.4,.5,.15),new q({color:11149858})),md.position.set(0,0,.2),Cd.add(md),hd=new G(new K(.51,.51,.51),new q({color:1118481}));let t=new G(new K(.4,.1,.52),new q({color:16764057}));t.position.set(0,.1,0),hd.add(t),Sd.add(hd)}pd.visible=o===`tophat`,md.visible=o===`backpack`,hd.visible=o===`ninja`}Ad()}var _d=new q({color:13421772}),vd=new q({color:65535}),yd=new q({color:16766720}),bd=new q({color:15132410}),xd=new q({color:2894904}),Sd,Cd,wd,Td,Ed,Dd;function Od(e,t){Ju=e,Yu=new cn,Yu.add(e),$=new Eu(Yu,document.body),Au=new ha,Au.near=.1,Au.far=5;let n=document.getElementById(`instructions`),r=!1;n?.addEventListener(`click`,()=>{r||$.lock()}),$.addEventListener(`lock`,()=>{n&&(n.style.display=`none`)}),$.addEventListener(`unlock`,()=>{n&&!r&&(n.style.display=`flex`)}),t.add($.object),t.add(Gu),Xu=new ln,Sd=new G(new K(.5,.5,.5),ad),Sd.position.y=.5,Qu=new G(new K(.52,.1,.52),sd),fd(ld,Qu),Sd.add(Qu),$u=new ln,$u.position.set(-.1,0,-.252);let i=new G(new K(.06,.08,.005),new Cr({color:16777215})),a=new G(new K(.03,.08,.006),ud);a.position.set(.015,0,0),$u.add(i,a),Sd.add($u),ed=new ln,ed.position.set(.1,0,-.252);let o=new G(new K(.06,.08,.005),new Cr({color:16777215})),s=new G(new K(.03,.08,.006),dd);s.position.set(-.015,0,0),ed.add(o,s),Sd.add(ed),Xu.add(Sd),Cd=new G(new K(.5,.75,.25),id),Cd.position.y=-.125,Xu.add(Cd),wd=new G(new K(.25,.75,.25),ad),wd.position.set(-.375,-.125,0),Xu.add(wd),Td=new G(new K(.25,.75,.25),ad),Td.position.set(.375,-.125,0),Xu.add(Td),Ed=new G(new K(.25,.75,.25),od),Ed.position.set(-.125,-.875,0),Xu.add(Ed),Dd=new G(new K(.25,.75,.25),od),Dd.position.set(.125,-.875,0),Xu.add(Dd),t.add(Xu),Xu.visible=!1,$.object.position.set(0,il(),0),document.addEventListener(`mousedown`,e=>{!$.isLocked&&!hu||e.button===0&&(Iu=!0,zu=!1,Lu=performance.now(),Bu=null)}),document.addEventListener(`mouseup`,e=>{if(!$.isLocked&&!hu||!Iu||(Iu=!1,Gu.visible=!1,e.button!==0))return;let t=performance.now()-Lu;Au.setFromCamera(new B(0,0),Ju);let n=Au.intersectObjects(Uc.children,!1);if(n.length>0&&!zu&&t<300){let e=n[0];if(e.face){let t=e.object,n=new V;if(t instanceof Kr&&e.instanceId!==void 0){let r=new Pt;t.getMatrixAt(e.instanceId,r),n.setFromMatrixPosition(r)}else n.copy(t.position);let i=`${Math.round(n.x)},${Math.round(n.y)},${Math.round(n.z)}`;if(Gc.get(i)===`crafting_table`){let e=document.getElementById(`full-inventory-modal`);e&&(gl(`3x3`),r=!0,e.style.display=`block`,$.unlock());return}let a=n.clone().add(e.face.normal);if(!qu(a)){let e=Z[ml];e&&e.count>0&&(e.type===`stick`||e.type.includes(`_`)&&e.type!==`crafting_table`||(dl(a,e.type),yl(ml,1)))}}}}),document.addEventListener(`keydown`,e=>{if((e.code===`F7`||e.code===`KeyV`||e.code===`F5`)&&(e.preventDefault(),Zu=(Zu+1)%3,Xu.visible=Zu!==0,Zu===1?(Ju.position.set(0,0,5),Ju.rotation.y=0,Au.far=10):Zu===2?(Ju.position.set(0,0,-5),Ju.rotation.y=Math.PI,Au.far=10):(Ju.position.set(0,0,0),Ju.rotation.y=0,Au.far=5)),e.code===`KeyI`){let e=document.getElementById(`full-inventory-modal`);e&&(e.style.display===`none`?(gl(`2x2`),r=!0,e.style.display=`block`,$.unlock()):(r=!1,e.style.display=`none`,$.lock()))}if(e.code===`KeyH`&&Fu>0){if(Pu.length<Fu)Pu.push({x:$.object.position.x,y:$.object.position.y,z:$.object.position.z,name:`Home ${Pu.length+1}`});else{let e=Math.max(0,Pu.length-1);Pu[e]={x:$.object.position.x,y:$.object.position.y,z:$.object.position.z,name:`Home ${e+1}`}}jd()}})}function kd(e){let t=Math.floor(e.x-.3+.5),n=Math.floor(e.x+.3+.5),r=Math.floor(e.z-.3+.5),i=Math.floor(e.z+.3+.5),a=Math.floor(e.y-1.75-.1+.5);for(let e=t;e<=n;e++)for(let t=r;t<=i;t++)if(al(e,a,t)||Jc.has(`${e},${a},${t}`))return!0;return!1}function Ad(){let e=Z[55];Fu=0,e&&e.type===`etherite_helmet`&&Fu++;let t=!1;e&&e.type.startsWith(`wood`)?(Sd.material=X.wood,t=!0):e&&e.type.startsWith(`stone`)?(Sd.material=X.stone,t=!0):e&&e.type.startsWith(`iron`)?(Sd.material=_d,t=!0):e&&e.type.startsWith(`diamond`)?(Sd.material=vd,t=!0):e&&e.type.startsWith(`gold`)?(Sd.material=yd,t=!0):e&&e.type.startsWith(`moonstone`)?(Sd.material=bd,t=!0):e&&e.type.startsWith(`etherite`)?(Sd.material=xd,t=!0):Sd.material=ad,Qu&&(Qu.visible=!t),$u&&($u.visible=!t),ed&&(ed.visible=!t);let n=Z[56];n&&n.type===`etherite_chestplate`&&Fu++;let r=id;n&&n.type.startsWith(`wood`)?r=X.wood:n&&n.type.startsWith(`stone`)?r=X.stone:n&&n.type.startsWith(`iron`)?r=_d:n&&n.type.startsWith(`diamond`)?r=vd:n&&n.type.startsWith(`gold`)?r=yd:n&&n.type.startsWith(`moonstone`)?r=bd:n&&n.type.startsWith(`etherite`)&&(r=xd),Cd.material=r,wd.material=r===id?ad:r,Td.material=r===id?ad:r;let i=Z[57],a=Z[58];i&&i.type===`etherite_leggings`&&Fu++,a&&a.type===`etherite_boots`&&Fu++;let o=od;i&&i.type.startsWith(`wood`)?o=X.wood:i&&i.type.startsWith(`stone`)?o=X.stone:i&&i.type.startsWith(`iron`)?o=_d:i&&i.type.startsWith(`diamond`)?o=vd:i&&i.type.startsWith(`gold`)?o=yd:i&&i.type.startsWith(`moonstone`)?o=bd:i&&i.type.startsWith(`etherite`)&&(o=xd);let s=o;a&&a.type.startsWith(`wood`)?s=X.wood:a&&a.type.startsWith(`stone`)?s=X.stone:a&&a.type.startsWith(`iron`)?s=_d:a&&a.type.startsWith(`diamond`)?s=vd:a&&a.type.startsWith(`gold`)?s=yd:a&&a.type.startsWith(`moonstone`)?s=bd:a&&a.type.startsWith(`etherite`)&&(s=xd),Ed.material=s,Dd.material=s,jd()}function jd(){let e=document.getElementById(`homes-sidebar`),t=document.getElementById(`homes-list`);if(!(!e||!t))if(Fu>0){e.style.display=`block`,t.innerHTML=``;for(let e=0;e<Fu;e++){let n=document.createElement(`li`),r=Pu[e];r?(n.className=`home-point`,n.innerText=r.name,n.onclick=()=>{$.object.position.set(r.x,r.y,r.z),ju.set(0,0,0),tl($.object.position,!0)}):(n.className=`home-point empty-home`,n.innerText=`[Empty Slot ${e+1}]`),t.appendChild(n)}}else e.style.display=`none`}function Md(){let e=performance.now(),t=(e-Nu)/1e3;if(t>.1&&(t=.1),Nu=e,Ad(),!$.isLocked&&!hu)return;if(hu&&(gu.x!==0||gu.y!==0)){let e=new Wt(0,0,0,`YXZ`);e.setFromQuaternion(Ju.quaternion),e.y-=gu.x*.005,e.x-=gu.y*.005,e.x=Math.max(-Math.PI/2,Math.min(Math.PI/2,e.x)),Ju.quaternion.setFromEuler(e),gu.x=0,gu.y=0}Xu.visible=Zu!==0,Xu.position.copy($.object.position),Xu.position.y-=.5;let n=new Wt(0,0,0,`YXZ`);if(n.setFromQuaternion($.object.quaternion),Xu.rotation.y=n.y,tl($.object.position),Iu){Au.setFromCamera(Hu,Ju);let t=Au.intersectObjects(Uc.children,!1);if(t.length>0){let n=t[0],r=n.object;Uu.set(0,0,0);let i=!1,a=-1;r instanceof Kr&&n.instanceId!==void 0?(i=!0,a=n.instanceId,r.getMatrixAt(a,Wu),Uu.setFromMatrixPosition(Wu)):Uu.copy(r.position);let o=`${Math.round(Uu.x)},${Math.round(Uu.y)},${Math.round(Uu.z)}`,s=Gc.get(o),c=!0;if(s===`stone`||s===`iron_ore`||s===`bedrock`||s===`diamond_ore`||s===`gold_ore`||s===`moonstone_ore`||s===`etherite_ore`){let e=Z[ml],t=e&&e.type.endsWith(`_pickaxe`)?e.type.replace(`_pickaxe`,``):``,n=[`wood`,`stone`,`iron`,`gold`,`diamond`,`moonstone`,`etherite`].indexOf(t);s===`bedrock`?c=!1:s===`etherite_ore`?c=n>=5:s===`moonstone_ore`?c=n>=4:s===`diamond_ore`||s===`gold_ore`?c=n>=2:s===`iron_ore`?c=n>=1:s===`stone`&&(c=n>=0)}if(!c)Gu.visible=!1,Bu=null;else if(Bu!==o)Bu=o,Lu=e,Gu.visible=!1;else{Gu.visible=!0,Gu.position.copy(Uu);let t=Math.min((e-Lu)/Vu,1);if(Gu.material=Bc[Math.floor(t*10)],t>=1){let t=null;if(t=i?ul(r,a,o):ul(r,void 0,o),t){let e=t;t===`iron_ore`&&(e=`iron_ingot`),t===`gold_ore`&&(e=`gold_ingot`),t===`diamond_ore`&&(e=`diamond`),t===`moonstone_ore`&&(e=`moonstone`),t===`etherite_ore`&&(e=`etherite`),vl(e,1)}Lu=e,zu=!0,Gu.visible=!1,Bu=null}}}else Gu.visible=!1,Bu=null}else Gu.visible=!1,Bu=null;ju.x-=ju.x*10*t,ju.z-=ju.z*10*t,ju.y-=9.8*3*t,Mu.z=Number(Q.forward)-Number(Q.backward),Mu.x=Number(Q.right)-Number(Q.left),Mu.normalize();let r=Q.run?150:50;if(Q.shift&&(r*=.3),(Q.forward||Q.backward)&&(ju.z-=Mu.z*r*t),(Q.left||Q.right)&&(ju.x-=Mu.x*r*t),Q.shift&&Ru){if(ju.x!==0){let e=$.object.position.clone();e.x+=ju.x*t,kd(e)||(ju.x=0)}if(ju.z!==0){let e=$.object.position.clone();e.z+=ju.z*t,kd(e)||(ju.z=0)}}Q.jump&&Ru&&(ju.y=10,Ru=!1);let i=$.object.position.clone();$.moveRight(-ju.x*t),$.moveForward(-ju.z*t);let a=$.object.position.x,o=$.object.position.z;$.object.position.copy(i),$.object.position.x=a,Ku($.object.position)&&($.object.position.x=i.x,Ru&&($.object.position.y+=1.1,$.object.position.x=a,Ku($.object.position)||(ju.y=10,Ru=!1),$.object.position.copy(i)),ju.x=0),$.object.position.z=o,Ku($.object.position)&&($.object.position.z=i.z,Ru&&($.object.position.y+=1.1,$.object.position.z=o,Ku($.object.position)||(ju.y=10,Ru=!1),$.object.position.y=i.y,$.object.position.z=i.z),ju.z=0),$.object.position.y+=ju.y*t,Ku($.object.position)?(Ru=ju.y<0,$.object.position.y=i.y,ju.y=0):Ru=!1,Nu=e}function Nd(e){let t={};Kc.forEach((e,n)=>{t[n]=e});let n={worldEdits:t,inventoryArr:Z,position:{x:$.object.position.x,y:$.object.position.y,z:$.object.position.z,ry:$.object.rotation.y,rx:$.object.rotation.x},homesArr:Pu};localStorage.setItem(`poxel_save_${e}`,JSON.stringify(n)),localStorage.setItem(`poxel_meta_${e}`,new Date().toLocaleString())}function Pd(e){let t=localStorage.getItem(`poxel_save_${e}`);if(!t)return!1;try{let e=JSON.parse(t);Pl(e.inventoryArr),Pu.splice(0,Pu.length,...e.homesArr),jd(),Kc.clear();for(let t of Object.keys(e.worldEdits)){let n=e.worldEdits[t];if(Kc.set(t,n),Gc.set(t,n),n!==`air`){let[e,r,i]=t.split(`,`).map(Number);dl(new V(e,r,i),n)}}$.object.position.set(e.position.x,e.position.y,e.position.z);let n=new Wt(0,0,0,`YXZ`);return n.x=e.position.rx,n.y=e.position.ry,$.object.quaternion.setFromEuler(n),Ad(),tl($.object.position,!0),!0}catch(e){return console.error(`Failed to load save:`,e),!1}}function Fd(e){return localStorage.getItem(`poxel_meta_${e}`)}var Id=new vn;Id.background=new W(8900331),Id.fog=new _n(8900331,10,50);var Ld=new qi(75,window.innerWidth/window.innerHeight,.1,1e3),Rd=new Ic({antialias:!1});Rd.setSize(window.innerWidth,window.innerHeight),Rd.setPixelRatio(window.devicePixelRatio),document.body.appendChild(Rd.domElement);var zd=new Zi(13421772,.6);Id.add(zd);var Bd=new Xi(16777215,.6);Bd.position.set(10,20,10),Id.add(Bd),nl(Id),_u(),Od(Ld,Id),Nl(),window.addEventListener(`resize`,Vd,!1);function Vd(){Ld.aspect=window.innerWidth/window.innerHeight,Ld.updateProjectionMatrix(),Rd.setSize(window.innerWidth,window.innerHeight);let e=document.querySelector(`.shop-preview`);if(e){let t=e.getBoundingClientRect();t.width>0&&(nf&&(nf.aspect=t.width/t.height),nf&&nf.updateProjectionMatrix(),rf&&rf.setSize(t.width,t.height))}}var Hd=-1,Ud=document.getElementById(`main-menu`),Wd=document.getElementById(`menu-screen-main`),Gd=document.getElementById(`save-slots-container`),Kd=document.getElementById(`shop-screen`);Wd?.addEventListener(`click`,e=>{if(e.target.tagName!==`BUTTON`)if(hu){Wd&&(Wd.style.display=`none`),Kd&&(Kd.style.display=`none`);let e=document.getElementById(`instructions`);e&&(e.style.display=`none`)}else $.lock()}),$.addEventListener(`lock`,()=>{Wd&&(Wd.style.display=`none`),Kd&&(Kd.style.display=`none`)}),$.addEventListener(`unlock`,()=>{hu||Wd&&(Wd.style.display=`flex`)});var qd=document.getElementById(`btn-new-game`),Jd=document.getElementById(`btn-open-load`),Yd=document.getElementById(`btn-back-load`),Xd=document.getElementById(`btn-shop`),Zd=document.getElementById(`btn-save-shop`),Qd=document.querySelectorAll(`.save-slot`),$d=document.getElementById(`btn-save-quit`),ef=document.getElementById(`shop-canvas`),tf=new vn,nf=new qi(50,1,.1,100);nf.position.set(0,0,4);var rf=new Ic({canvas:ef,alpha:!0,antialias:!0});rf.setPixelRatio(window.devicePixelRatio),tf.add(new Zi(16777215,.8));var af=new Xi(16777215,.6);af.position.set(5,10,5),tf.add(af);var of=new ln,sf=new q({color:localStorage.getItem(`poxel_skin`)||`#ffcc99`}),cf=new q({color:localStorage.getItem(`poxel_shirt`)||`#00aaff`}),lf=new q({color:localStorage.getItem(`poxel_pants`)||`#0000aa`}),uf=new q({color:localStorage.getItem(`poxel_hair`)||`#6b4423`}),df=localStorage.getItem(`poxel_eye`)||`#000000`,ff=parseInt(localStorage.getItem(`poxel_style`)||`0`),pf=new G(new K(.5,.5,.5),sf);pf.position.y=.5;var mf=new G(new K(.52,.1,.52),uf);fd(ff,mf),pf.add(mf);var hf,gf,_f=(e,t)=>{let n=new ln;n.position.set(e,0,-.252),n.add(new G(new K(.06,.08,.005),new Cr({color:16777215})));let r=new G(new K(.03,.08,.006),new Cr({color:df}));return r.position.set(-e*.15,0,0),n.add(r),t?hf=r:gf=r,n};pf.add(_f(-.1,!0)),pf.add(_f(.1,!1)),of.add(pf);var vf=new G(new K(.5,.75,.25),cf);vf.position.y=-.125,of.add(vf);var yf=new G(new K(.25,.75,.25),sf);yf.position.set(-.375,-.125,0),of.add(yf);var bf=new G(new K(.25,.75,.25),sf);bf.position.set(.375,-.125,0),of.add(bf);var xf=new G(new K(.25,.75,.25),lf);xf.position.set(-.125,-.875,0),of.add(xf);var Sf=new G(new K(.25,.75,.25),lf);Sf.position.set(.125,-.875,0),of.add(Sf),of.position.y=.25,tf.add(of);var Cf=localStorage.getItem(`poxel_super`)||`none`;function wf(e,t,n){let r=new G(new oi(.2,.2,.4),new q({color:1118481})),i=new G(new oi(.35,.35,.05),new q({color:1118481}));i.position.y=-.2,r.add(i),r.position.y=.45,t.add(r);let a=new G(new K(.4,.5,.15),new q({color:11149858}));a.position.set(0,0,.2),n.add(a);let o=new G(new K(.51,.51,.51),new q({color:1118481})),s=new G(new K(.4,.1,.52),new q({color:16764057}));return s.position.set(0,.1,0),o.add(s),t.add(o),{tophat:r,backpack:a,ninja:o}}var Tf=wf(of,pf,vf);function Ef(e,t){t.tophat.visible=e===`tophat`,t.backpack.visible=e===`backpack`,t.ninja.visible=e===`ninja`}Ef(Cf,Tf);var Df=!1,Of=0,kf=0,Af=document.querySelector(`.shop-preview`);Af&&(Af.addEventListener(`mousedown`,e=>{Df=!0,Of=e.clientX,kf=e.clientY}),window.addEventListener(`mouseup`,()=>Df=!1),window.addEventListener(`mousemove`,e=>{Df&&(of.rotation.y+=(e.clientX-Of)*.01,of.rotation.x=Math.max(-.5,Math.min(.5,of.rotation.x+(e.clientY-kf)*.01)),Of=e.clientX,kf=e.clientY)}));var jf=sf.color.getHexString(),Mf=cf.color.getHexString(),Nf=lf.color.getHexString(),Pf=uf.color.getHexString(),Ff=df.replace(`#`,``),If=[`#ffcc99`,`#f2d3ab`,`#e0ac69`,`#c68642`,`#8d5524`,`#3d2c23`],Lf=[`#00aaff`,`#33cc33`,`#ff3333`,`#ffff33`,`#ff9900`,`#aa00aa`,`#ffffff`,`#111111`,`#555555`],Rf=[`#0000aa`,`#00aa00`,`#aa0000`,`#aaaa00`,`#222222`,`#666666`,`#ffffff`,`#0055ff`],zf=[`#6b4423`,`#111111`,`#ddbb55`,`#cc3333`,`#aa5500`,`#3333cc`,`#e6e6fa`,`#ffffff`],Bf=[`#000000`,`#0055ff`,`#00aa00`,`#8d5524`,`#aa0000`,`#aa00aa`,`#ffffff`];function Vf(e,t,n){let r=document.getElementById(e);r&&(r.innerHTML=``,t.forEach(e=>{let t=document.createElement(`div`);t.className=`color-swatch`,t.style.backgroundColor=e;let i=`#`+(n===`skin`?jf:n===`shirt`?Mf:n===`pants`?Nf:n===`hair`?Pf:Ff);e.toLowerCase()===i.toLowerCase()&&t.classList.add(`selected`),t.addEventListener(`click`,()=>{Array.from(r.children).forEach(e=>e.classList.remove(`selected`)),t.classList.add(`selected`),n===`skin`&&(jf=e.slice(1),sf.color.set(e)),n===`shirt`&&(Mf=e.slice(1),cf.color.set(e)),n===`pants`&&(Nf=e.slice(1),lf.color.set(e)),n===`hair`&&(Pf=e.slice(1),uf.color.set(e)),n===`eye`&&(Ff=e.slice(1),hf.material=new Cr({color:e}),gf.material=new Cr({color:e}))}),r.appendChild(t)}))}Vf(`grid-skin`,If,`skin`),Vf(`grid-shirt`,Lf,`shirt`),Vf(`grid-pants`,Rf,`pants`),Vf(`grid-hair`,zf,`hair`),Vf(`grid-eyes`,Bf,`eye`);var Hf=[{id:`none`,name:`Remove Set`,rarity:`common`,unlockMin:0},{id:`tophat`,name:`Mayor Set`,rarity:`rare`,unlockMin:5,shirt:`#111111`,pants:`#222222`},{id:`backpack`,name:`Explorer Set`,rarity:`epic`,unlockMin:10,shirt:`#8d5524`,pants:`#556b2f`},{id:`ninja`,name:`Ninja Set`,rarity:`legendary`,unlockMin:15,shirt:`#111111`,pants:`#111111`,skin:`#f2d3ab`}],Uf=parseInt(localStorage.getItem(`poxel_playtime`)||`0`);setInterval(()=>{$.isLocked&&(Uf++,Uf%10==0&&localStorage.setItem(`poxel_playtime`,Uf.toString()))},1e3);function Wf(){let e=document.getElementById(`grid-super`);e&&(e.innerHTML=``,Hf.forEach(t=>{let n=document.createElement(`div`);n.className=`super-item-card rarity-${t.rarity}`,Cf===t.id&&n.classList.add(`selected`);let r=Uf>=t.unlockMin*60,i=t.id===`tophat`?`🎩`:t.id===`backpack`?`🎒`:t.id===`ninja`?`🥷`:`❌`;if(r)n.innerHTML=`<div style="font-size:50px; margin-bottom:10px;">${i}</div><div class="item-name">${t.name}</div>`,n.addEventListener(`click`,()=>{Array.from(e.children).forEach(e=>e.classList.remove(`selected`)),n.classList.add(`selected`),Cf=t.id,Ef(Cf,Tf),t.shirt&&(Mf=t.shirt.slice(1),cf.color.set(t.shirt),Array.from(document.getElementById(`grid-shirt`)?.children||[]).forEach(e=>e.classList.remove(`selected`))),t.pants&&(Nf=t.pants.slice(1),lf.color.set(t.pants),Array.from(document.getElementById(`grid-pants`)?.children||[]).forEach(e=>e.classList.remove(`selected`))),t.skin&&(jf=t.skin.slice(1),sf.color.set(t.skin),Array.from(document.getElementById(`grid-skin`)?.children||[]).forEach(e=>e.classList.remove(`selected`)))});else{n.style.opacity=`0.5`;let e=Math.floor(Uf/60);n.innerHTML=`<div style="font-size:40px; margin-bottom:5px;">🔒</div><div style="font-size:14px; font-weight:bold;">Play ${t.unlockMin}m</div><div class="item-name">${e}/${t.unlockMin}m</div>`}e.appendChild(n)}))}var Gf=document.querySelectorAll(`#grid-hair-style .shop-tab`);Gf.forEach(e=>{let t=parseInt(e.dataset.style||`-1`);t===ff&&(Gf.forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`)),e.addEventListener(`click`,()=>{Gf.forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`),ff=t,fd(ff,mf)})});var Kf=document.querySelectorAll(`.shop-tab`),qf=document.querySelectorAll(`.shop-tab-content`);Kf.forEach(e=>{e.addEventListener(`click`,()=>{Kf.forEach(e=>e.classList.remove(`active`)),qf.forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let t=e.dataset.tab;document.getElementById(`tab-${t}`)?.classList.add(`active`);let n=document.getElementById(`shop-screen`);if(n){t===`super`?n.classList.add(`super-mode`):n.classList.remove(`super-mode`);let e=0,r=setInterval(()=>{Vd(),e++,e>15&&clearInterval(r)},35)}})}),Qd.forEach(e=>{let t=parseInt(e.dataset.slot),n=Fd(t);n&&(e.innerHTML=`Save ${t+1}<br><span style="font-size:12px;color:#ccc">${n}</span>`)}),qd?.addEventListener(`click`,()=>{Hd=0,Jf()}),Jd?.addEventListener(`click`,()=>{Wd&&(Wd.style.display=`none`),Gd&&(Gd.style.display=`flex`)}),Yd?.addEventListener(`click`,()=>{Gd&&(Gd.style.display=`none`),Wd&&(Wd.style.display=`flex`)}),Xd?.addEventListener(`click`,()=>{Wd&&(Wd.style.display=`none`),Kd&&(Wf(),Kd.style.display=`flex`,setTimeout(()=>Vd(),10))}),Zd?.addEventListener(`click`,()=>{localStorage.setItem(`poxel_skin`,`#`+jf),localStorage.setItem(`poxel_shirt`,`#`+Mf),localStorage.setItem(`poxel_pants`,`#`+Nf),localStorage.setItem(`poxel_hair`,`#`+Pf),localStorage.setItem(`poxel_eye`,`#`+Ff),localStorage.setItem(`poxel_style`,ff.toString()),localStorage.setItem(`poxel_super`,Cf),gd(`#`+jf,`#`+Mf,`#`+Nf,`#`+Pf,`#`+Ff,ff,Cf),Kd&&(Kd.style.display=`none`),Wd&&(Wd.style.display=`flex`)}),Qd.forEach(e=>{e.addEventListener(`click`,e=>{let t=parseInt(e.currentTarget.dataset.slot);Pd(t)?(Hd=t,Jf()):(console.warn(`Save slot empty.`),Hd=t,Jf())})}),$d?.addEventListener(`click`,()=>{Hd!==-1&&(Nd(Hd),location.reload())});function Jf(){Ud&&(Ud.style.display=`none`);let e=document.getElementById(`instructions`);if(hu){e&&(e.style.display=`none`);try{let e=document.documentElement;e.requestFullscreen?e.requestFullscreen():e.webkitRequestFullscreen&&e.webkitRequestFullscreen()}catch{}try{screen.orientation.lock(`landscape`).catch(()=>{})}catch{}}else e&&(e.style.display=`flex`),$.lock()}var Yf=document.getElementById(`debug`),Xf=0;function Zf(){requestAnimationFrame(Zf),Md(),Ud&&Ud.style.display!==`none`&&($.object.rotation.y-=.002),Rd.render(Id,Ld),Kd&&Kd.style.display!==`none`&&(Df||(of.rotation.y+=.005),rf.render(tf,nf)),Yf&&++Xf%30==0&&(Yf.innerHTML=`
      Pos: ${$.object.position.x.toFixed(1)}, ${$.object.position.y.toFixed(1)}, ${$.object.position.z.toFixed(1)}
    `)}console.log(`main.ts execution reached end`),window.scene=Id,window.camera=Ld,window.chunkGroup=Id.children.find(e=>e.type===`Group`),console.log(`Chunk group children: `,window.chunkGroup?.children.length),Zf();